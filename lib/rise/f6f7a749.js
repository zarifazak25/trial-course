"use strict";(globalThis.wpRiseJsonp=globalThis.wpRiseJsonp||[]).push([["defaultVendors-node_modules_pnpm_articulate_design-system_1_13_0__articulate_design-system-to-8c2658"],{84113(wl,ut,Wa){Wa.r(ut),Wa.d(ut,{Arc:()=>Ks,ArcAbstractFlexLayouts:()=>Uo,ArcAbstractGapSizes:()=>gt,ArcAbstractIconSizes:()=>$e,ArcAbstractOrientations:()=>Yo,ArcAbstractPopoverActions:()=>Za,ArcAbstractPopoverModes:()=>xe,ArcAbstractTextLayouts:()=>No,ArcAbstractTextOverflows:()=>ft,ArcAbstractTextSizes:()=>Fo,ArcAvatar:()=>He,ArcAvatarColors:()=>Ft,ArcAvatarColorsReserved:()=>un,ArcAvatarOverflow:()=>Xi,ArcAvatarOverflowSizes:()=>bn,ArcAvatarPile:()=>Vn,ArcAvatarPileSizes:()=>fn,ArcAvatarSizes:()=>hn,ArcAvatarText:()=>Ve,ArcAvatarTextGapSizes:()=>vn,ArcAvatarTextOverflows:()=>mn,ArcAvatarTextSizes:()=>gn,ArcBadge:()=>ac,ArcBadgeContrasts:()=>Qi,ArcBadgeCount:()=>ic,ArcBadgeCountShapes:()=>nc,ArcBadgeCountSizes:()=>tc,ArcBadgeCountVariants:()=>oc,ArcBadgeLayouts:()=>Ji,ArcBadgeSizes:()=>Ki,ArcBadgeVariants:()=>rc,ArcButton:()=>ur,ArcButtonDeprecatedVariants:()=>$o,ArcButtonHierarchies:()=>ki,ArcButtonLayouts:()=>yi,ArcButtonPopoverActions:()=>Ai,ArcButtonShapes:()=>xi,ArcButtonSizes:()=>$i,ArcButtonVariants:()=>wi,ArcCheckbox:()=>Ao,ArcCheckboxBar:()=>$c,ArcCheckboxBarLayouts:()=>fc,ArcCheckboxBarOption:()=>xc,ArcCheckboxBarSizes:()=>bc,ArcCheckboxLayouts:()=>hc,ArcCheckboxSizes:()=>vc,ArcCheckboxVariants:()=>mc,ArcDropdownMenu:()=>Ke,ArcIcon:()=>B,ArcIconText:()=>Er,ArcIconTextVariants:()=>ei,ArcInputAction:()=>Ic,ArcLabel:()=>ca,ArcLabelContent:()=>sa,ArcLabelLayouts:()=>sc,ArcLink:()=>Pc,ArcLinkVariants:()=>Mc,ArcModal:()=>as,ArcModalAlert:()=>ts,ArcModalAlertDefaults:()=>Jr,ArcModalAlertVariants:()=>Oc,ArcModalBackdropColors:()=>Dc,ArcModalBodyPaddings:()=>Hc,ArcModalCloseReasons:()=>Fc,ArcModalCommonDefaults:()=>fr,ArcModalCommonVariants:()=>Rc,ArcModalConfirm:()=>Io,ArcModalConfirmDefaults:()=>da,ArcModalConfirmVariants:()=>Bc,ArcModalSizes:()=>Vc,ArcPopover:()=>Ba,ArcPopoverActions:()=>Nn,ArcPopoverAnchors:()=>Qt,ArcPopoverBoundaries:()=>ro,ArcPopoverButton:()=>Pa,ArcPopoverDefaults:()=>wr,ArcPopoverDensities:()=>ao,ArcPopoverModes:()=>Jt,ArcPopoverVariants:()=>Fe,ArcPopoverVariantsWithOutline:()=>Un,ArcRadio:()=>Lo,ArcRadioBar:()=>ps,ArcRadioBarLayouts:()=>ss,ArcRadioBarOption:()=>ds,ArcRadioBarSizes:()=>ls,ArcRadioLayouts:()=>ns,ArcRadioSizes:()=>is,ArcSelect:()=>Ls,ArcSelectLayouts:()=>hs,ArcSelectSizes:()=>vs,ArcSelectVariants:()=>ms,ArcSwitch:()=>Bs,ArcSwitchLabelPositions:()=>wa,ArcSwitchSizes:()=>Ms,ArcSwitchStates:()=>ar,ArcSystemAlignments:()=>vt,ArcSystemColors:()=>be,ArcSystemHierarchies:()=>ht,ArcSystemLayouts:()=>Hr,ArcSystemLineHeights:()=>mt,ArcSystemShapes:()=>fe,ArcSystemSizes:()=>yr,ArcSystemVariants:()=>Q,ArcTextAlignments:()=>Ys,ArcTextBodyElements:()=>Bo,ArcTextBodySizes:()=>Ns,ArcTextBodyVariants:()=>Us,ArcTextElements:()=>Oo,ArcTextHeadingElements:()=>Ro,ArcTextHeadingSizes:()=>Hs,ArcTextHeadingVariants:()=>Fs,ArcTextInput:()=>el,ArcTextInputLayouts:()=>Js,ArcTextInputSizes:()=>Qs,ArcTextInputTypes:()=>al,ArcTextInputVariants:()=>rl,ArcTextKinds:()=>Os,ArcTextLineHeights:()=>Ws,ArcTextSubheadingSizes:()=>Vs,ArcTextTitleSizes:()=>Ds,ArcToast:()=>Vo,ArcToastPlacements:()=>ul,ArcToastPopoverActions:()=>pl,ArcToastPopoverModes:()=>dl,ArcToastProgressBarVariants:()=>hl,ArcToastSeverities:()=>cl,ArcToastSizes:()=>sl,ArcToastVariants:()=>ll,ArcTooltip:()=>xo,ArcTooltipDefaults:()=>Tr,SVGLogoArticulate:()=>Le,SVGLogoProductAI:()=>Me,SVGLogoProductPeek:()=>Pe,SVGLogoProductReach:()=>Re,SVGLogoProductReview:()=>Be,SVGLogoProductRise:()=>Oe,SVGLogoProductStoryline:()=>De,adoptStyles:()=>O,assignRef:()=>bt,bindDelegatedEvents:()=>bo,clamp:()=>xt,createEmptyRect:()=>Ia,css:()=>u,didElementRectChange:()=>$t,extractTextFromReactNode:()=>Ta,getPreferredAnchorForTooltipId:()=>Xe,isDifferent:()=>ea,isFixedDetector:()=>uo,isSame:()=>Ga,joinArray:()=>ho,logError:()=>Kn,logMessage:()=>qn,logWarning:()=>vo,makeHtmlId:()=>Fn,mapDeprecated:()=>Wo,pickFromList:()=>z,shareAdoptedStyles:()=>sn,unbindDelegatedEvents:()=>fi,updatePopoverPosition:()=>Ne,useStableId:()=>Sr});const fe=["circle","square","narrow"],Q=["inherit","common","disabled","neutral","outline","solid","plain","critical","ai","primary","secondary","tertiary","inverse","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse","overlay-light","overlay-dark","brand-black","brand-blue","brand","info","success","warning","error","processing"],ht=["primary","secondary","tertiary","plain"],Hr=["hug","fill","icon","gutter","inline"],vt=["inherit","start","left","justify","center","between","around","evenly","stretch","end","right"],mt=["inherit","tight","standard","loose"],yr=["inherit","xxl","xl","lg","md","sm","xs","xxs","custom","fullscreen"],be=["blue","orange","mint","red","yellow","green","maroon","purple","neutral","white","black"],xe=["","auto","manual"],Za=["toggle","show","hide"],$e=["inherit","xl","lg","md","sm","xs"],gt=["inherit","lg","md","sm"],Fo=["inherit","md","sm"],ft=["inherit","wrap","truncate"],No=["gutter","inline"],Uo=["hug","fill"],Yo=["horizontal","vertical"],Wo=(r,a)=>a[r]||r,z=(r,a)=>r.filter(e=>a.includes(e)),bt=(r,a)=>{r&&(typeof r=="function"?r(a):r.current=a)},xt=(r,a=0,e=100)=>Math.min(Math.max(r,a),e),ea=(r,a)=>r!==a,Ga=(r,a)=>r===a,$t=({a:r,b:a})=>ea(r?.top,a?.top)||ea(r?.left,a?.left)||ea(r?.width,a?.width)||ea(r?.height,a?.height);var t=Wa(31042),b=Wa(15648);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xa=globalThis,ye=Xa.ShadowRoot&&(Xa.ShadyCSS===void 0||Xa.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,we=Symbol(),yt=new WeakMap;class wt{constructor(a,e,n){if(this._$cssResult$=!0,n!==we)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=a,this.t=e}get styleSheet(){let a=this.o;const e=this.t;if(ye&&a===void 0){const n=e!==void 0&&e.length===1;n&&(a=yt.get(e)),a===void 0&&((this.o=a=new CSSStyleSheet).replaceSync(this.cssText),n&&yt.set(e,a))}return a}toString(){return this.cssText}}const Zo=r=>new wt(typeof r=="string"?r:r+"",void 0,we),u=(r,...a)=>{const e=r.length===1?r[0]:a.reduce(((n,i,c)=>n+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[c+1]),r[0]);return new wt(e,r,we)},Go=(r,a)=>{if(ye)r.adoptedStyleSheets=a.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const e of a){const n=document.createElement("style"),i=Xa.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=e.cssText,r.appendChild(n)}},kt=ye?r=>r:r=>r instanceof CSSStyleSheet?(a=>{let e="";for(const n of a.cssRules)e+=n.cssText;return Zo(e)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Xo,defineProperty:qo,getOwnPropertyDescriptor:Ko,getOwnPropertyNames:Jo,getOwnPropertySymbols:Qo,getPrototypeOf:rn}=Object,qa=globalThis,At=qa.trustedTypes,an=At?At.emptyScript:"",en=qa.reactiveElementPolyfillSupport,za=(r,a)=>r,ke={toAttribute(r,a){switch(a){case Boolean:r=r?an:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,a){let e=r;switch(a){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},zt=(r,a)=>!Xo(r,a),Ct={attribute:!0,type:String,converter:ke,reflect:!1,useDefault:!1,hasChanged:zt};Symbol.metadata??=Symbol("metadata"),qa.litPropertyMetadata??=new WeakMap;class pa extends HTMLElement{static addInitializer(a){this._$Ei(),(this.l??=[]).push(a)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(a,e=Ct){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(a)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(a,e),!e.noAccessor){const n=Symbol(),i=this.getPropertyDescriptor(a,n,e);i!==void 0&&qo(this.prototype,a,i)}}static getPropertyDescriptor(a,e,n){const{get:i,set:c}=Ko(this.prototype,a)??{get(){return this[e]},set(s){this[e]=s}};return{get:i,set(s){const d=i?.call(this);c?.call(this,s),this.requestUpdate(a,d,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(a){return this.elementProperties.get(a)??Ct}static _$Ei(){if(this.hasOwnProperty(za("elementProperties")))return;const a=rn(this);a.finalize(),a.l!==void 0&&(this.l=[...a.l]),this.elementProperties=new Map(a.elementProperties)}static finalize(){if(this.hasOwnProperty(za("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(za("properties"))){const e=this.properties,n=[...Jo(e),...Qo(e)];for(const i of n)this.createProperty(i,e[i])}const a=this[Symbol.metadata];if(a!==null){const e=litPropertyMetadata.get(a);if(e!==void 0)for(const[n,i]of e)this.elementProperties.set(n,i)}this._$Eh=new Map;for(const[e,n]of this.elementProperties){const i=this._$Eu(e,n);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(a){const e=[];if(Array.isArray(a)){const n=new Set(a.flat(1/0).reverse());for(const i of n)e.unshift(kt(i))}else a!==void 0&&e.push(kt(a));return e}static _$Eu(a,e){const n=e.attribute;return n===!1?void 0:typeof n=="string"?n:typeof a=="string"?a.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((a=>this.enableUpdating=a)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((a=>a(this)))}addController(a){(this._$EO??=new Set).add(a),this.renderRoot!==void 0&&this.isConnected&&a.hostConnected?.()}removeController(a){this._$EO?.delete(a)}_$E_(){const a=new Map,e=this.constructor.elementProperties;for(const n of e.keys())this.hasOwnProperty(n)&&(a.set(n,this[n]),delete this[n]);a.size>0&&(this._$Ep=a)}createRenderRoot(){const a=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Go(a,this.constructor.elementStyles),a}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((a=>a.hostConnected?.()))}enableUpdating(a){}disconnectedCallback(){this._$EO?.forEach((a=>a.hostDisconnected?.()))}attributeChangedCallback(a,e,n){this._$AK(a,n)}_$ET(a,e){const n=this.constructor.elementProperties.get(a),i=this.constructor._$Eu(a,n);if(i!==void 0&&n.reflect===!0){const c=(n.converter?.toAttribute!==void 0?n.converter:ke).toAttribute(e,n.type);this._$Em=a,c==null?this.removeAttribute(i):this.setAttribute(i,c),this._$Em=null}}_$AK(a,e){const n=this.constructor,i=n._$Eh.get(a);if(i!==void 0&&this._$Em!==i){const c=n.getPropertyOptions(i),s=typeof c.converter=="function"?{fromAttribute:c.converter}:c.converter?.fromAttribute!==void 0?c.converter:ke;this._$Em=i;const d=s.fromAttribute(e,c.type);this[i]=d??this._$Ej?.get(i)??d,this._$Em=null}}requestUpdate(a,e,n){if(a!==void 0){const i=this.constructor,c=this[a];if(n??=i.getPropertyOptions(a),!((n.hasChanged??zt)(c,e)||n.useDefault&&n.reflect&&c===this._$Ej?.get(a)&&!this.hasAttribute(i._$Eu(a,n))))return;this.C(a,e,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(a,e,{useDefault:n,reflect:i,wrapped:c},s){n&&!(this._$Ej??=new Map).has(a)&&(this._$Ej.set(a,s??e??this[a]),c!==!0||s!==void 0)||(this._$AL.has(a)||(this.hasUpdated||n||(e=void 0),this._$AL.set(a,e)),i===!0&&this._$Em!==a&&(this._$Eq??=new Set).add(a))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const a=this.scheduleUpdate();return a!=null&&await a,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[i,c]of this._$Ep)this[i]=c;this._$Ep=void 0}const n=this.constructor.elementProperties;if(n.size>0)for(const[i,c]of n){const{wrapped:s}=c,d=this[i];s!==!0||this._$AL.has(i)||d===void 0||this.C(i,void 0,c,d)}}let a=!1;const e=this._$AL;try{a=this.shouldUpdate(e),a?(this.willUpdate(e),this._$EO?.forEach((n=>n.hostUpdate?.())),this.update(e)):this._$EM()}catch(n){throw a=!1,this._$EM(),n}a&&this._$AE(e)}willUpdate(a){}_$AE(a){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(a)),this.updated(a)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(a){return!0}update(a){this._$Eq&&=this._$Eq.forEach((e=>this._$ET(e,this[e]))),this._$EM()}updated(a){}firstUpdated(a){}}pa.elementStyles=[],pa.shadowRootOptions={mode:"open"},pa[za("elementProperties")]=new Map,pa[za("finalized")]=new Map,en?.({ReactiveElement:pa}),(qa.reactiveElementVersions??=[]).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae=globalThis,Ka=Ae.trustedTypes,St=Ka?Ka.createPolicy("lit-html",{createHTML:r=>r}):void 0,ze="$lit$",Vr=`lit$${Math.random().toFixed(9).slice(2)}$`,Ce="?"+Vr,tn=`<${Ce}>`,ta=document,Ca=()=>ta.createComment(""),Sa=r=>r===null||typeof r!="object"&&typeof r!="function",Se=Array.isArray,jt=r=>Se(r)||typeof r?.[Symbol.iterator]=="function",je=`[ 	
\f\r]`,ja=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Et=/-->/g,_t=/>/g,oa=RegExp(`>|${je}(?:([^\\s"'>=/]+)(${je}*=${je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Tt=/'/g,It=/"/g,Lt=/^(?:script|style|textarea|title)$/i,Ee=r=>(a,...e)=>({_$litType$:r,strings:a,values:e}),kl=Ee(1),Al=Ee(2),zl=Ee(3),ua=Symbol.for("lit-noChange"),rr=Symbol.for("lit-nothing"),Mt=new WeakMap,na=ta.createTreeWalker(ta,129);function Pt(r,a){if(!Se(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return St!==void 0?St.createHTML(a):a}const Rt=(r,a)=>{const e=r.length-1,n=[];let i,c=a===2?"<svg>":a===3?"<math>":"",s=ja;for(let d=0;d<e;d++){const l=r[d];let p,h,v=-1,g=0;for(;g<l.length&&(s.lastIndex=g,h=s.exec(l),h!==null);)g=s.lastIndex,s===ja?h[1]==="!--"?s=Et:h[1]!==void 0?s=_t:h[2]!==void 0?(Lt.test(h[2])&&(i=RegExp("</"+h[2],"g")),s=oa):h[3]!==void 0&&(s=oa):s===oa?h[0]===">"?(s=i??ja,v=-1):h[1]===void 0?v=-2:(v=s.lastIndex-h[2].length,p=h[1],s=h[3]===void 0?oa:h[3]==='"'?It:Tt):s===It||s===Tt?s=oa:s===Et||s===_t?s=ja:(s=oa,i=void 0);const f=s===oa&&r[d+1].startsWith("/>")?" ":"";c+=s===ja?l+tn:v>=0?(n.push(p),l.slice(0,v)+ze+l.slice(v)+Vr+f):l+Vr+(v===-2?d:f)}return[Pt(r,c+(r[e]||"<?>")+(a===2?"</svg>":a===3?"</math>":"")),n]};class Ea{constructor({strings:a,_$litType$:e},n){let i;this.parts=[];let c=0,s=0;const d=a.length-1,l=this.parts,[p,h]=Rt(a,e);if(this.el=Ea.createElement(p,n),na.currentNode=this.el.content,e===2||e===3){const v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(i=na.nextNode())!==null&&l.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const v of i.getAttributeNames())if(v.endsWith(ze)){const g=h[s++],f=i.getAttribute(v).split(Vr),w=/([.?@])?(.*)/.exec(g);l.push({type:1,index:c,name:w[2],strings:f,ctor:w[1]==="."?Ot:w[1]==="?"?Dt:w[1]==="@"?Ht:_a}),i.removeAttribute(v)}else v.startsWith(Vr)&&(l.push({type:6,index:c}),i.removeAttribute(v));if(Lt.test(i.tagName)){const v=i.textContent.split(Vr),g=v.length-1;if(g>0){i.textContent=Ka?Ka.emptyScript:"";for(let f=0;f<g;f++)i.append(v[f],Ca()),na.nextNode(),l.push({type:2,index:++c});i.append(v[g],Ca())}}}else if(i.nodeType===8)if(i.data===Ce)l.push({type:2,index:c});else{let v=-1;for(;(v=i.data.indexOf(Vr,v+1))!==-1;)l.push({type:7,index:c}),v+=Vr.length-1}c++}}static createElement(a,e){const n=ta.createElement("template");return n.innerHTML=a,n}}function ia(r,a,e=r,n){if(a===ua)return a;let i=n!==void 0?e._$Co?.[n]:e._$Cl;const c=Sa(a)?void 0:a._$litDirective$;return i?.constructor!==c&&(i?._$AO?.(!1),c===void 0?i=void 0:(i=new c(r),i._$AT(r,e,n)),n!==void 0?(e._$Co??=[])[n]=i:e._$Cl=i),i!==void 0&&(a=ia(r,i._$AS(r,a.values),i,n)),a}class Bt{constructor(a,e){this._$AV=[],this._$AN=void 0,this._$AD=a,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(a){const{el:{content:e},parts:n}=this._$AD,i=(a?.creationScope??ta).importNode(e,!0);na.currentNode=i;let c=na.nextNode(),s=0,d=0,l=n[0];for(;l!==void 0;){if(s===l.index){let p;l.type===2?p=new ha(c,c.nextSibling,this,a):l.type===1?p=new l.ctor(c,l.name,l.strings,this,a):l.type===6&&(p=new Vt(c,this,a)),this._$AV.push(p),l=n[++d]}s!==l?.index&&(c=na.nextNode(),s++)}return na.currentNode=ta,i}p(a){let e=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(a,n,e),e+=n.strings.length-2):n._$AI(a[e])),e++}}class ha{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(a,e,n,i){this.type=2,this._$AH=rr,this._$AN=void 0,this._$AA=a,this._$AB=e,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let a=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&a?.nodeType===11&&(a=e.parentNode),a}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(a,e=this){a=ia(this,a,e),Sa(a)?a===rr||a==null||a===""?(this._$AH!==rr&&this._$AR(),this._$AH=rr):a!==this._$AH&&a!==ua&&this._(a):a._$litType$!==void 0?this.$(a):a.nodeType!==void 0?this.T(a):jt(a)?this.k(a):this._(a)}O(a){return this._$AA.parentNode.insertBefore(a,this._$AB)}T(a){this._$AH!==a&&(this._$AR(),this._$AH=this.O(a))}_(a){this._$AH!==rr&&Sa(this._$AH)?this._$AA.nextSibling.data=a:this.T(ta.createTextNode(a)),this._$AH=a}$(a){const{values:e,_$litType$:n}=a,i=typeof n=="number"?this._$AC(a):(n.el===void 0&&(n.el=Ea.createElement(Pt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(e);else{const c=new Bt(i,this),s=c.u(this.options);c.p(e),this.T(s),this._$AH=c}}_$AC(a){let e=Mt.get(a.strings);return e===void 0&&Mt.set(a.strings,e=new Ea(a)),e}k(a){Se(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let n,i=0;for(const c of a)i===e.length?e.push(n=new ha(this.O(Ca()),this.O(Ca()),this,this.options)):n=e[i],n._$AI(c),i++;i<e.length&&(this._$AR(n&&n._$AB.nextSibling,i),e.length=i)}_$AR(a=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);a!==this._$AB;){const n=a.nextSibling;a.remove(),a=n}}setConnected(a){this._$AM===void 0&&(this._$Cv=a,this._$AP?.(a))}}class _a{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(a,e,n,i,c){this.type=1,this._$AH=rr,this._$AN=void 0,this.element=a,this.name=e,this._$AM=i,this.options=c,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=rr}_$AI(a,e=this,n,i){const c=this.strings;let s=!1;if(c===void 0)a=ia(this,a,e,0),s=!Sa(a)||a!==this._$AH&&a!==ua,s&&(this._$AH=a);else{const d=a;let l,p;for(a=c[0],l=0;l<c.length-1;l++)p=ia(this,d[n+l],e,l),p===ua&&(p=this._$AH[l]),s||=!Sa(p)||p!==this._$AH[l],p===rr?a=rr:a!==rr&&(a+=(p??"")+c[l+1]),this._$AH[l]=p}s&&!i&&this.j(a)}j(a){a===rr?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,a??"")}}class Ot extends _a{constructor(){super(...arguments),this.type=3}j(a){this.element[this.name]=a===rr?void 0:a}}class Dt extends _a{constructor(){super(...arguments),this.type=4}j(a){this.element.toggleAttribute(this.name,!!a&&a!==rr)}}class Ht extends _a{constructor(a,e,n,i,c){super(a,e,n,i,c),this.type=5}_$AI(a,e=this){if((a=ia(this,a,e,0)??rr)===ua)return;const n=this._$AH,i=a===rr&&n!==rr||a.capture!==n.capture||a.once!==n.once||a.passive!==n.passive,c=a!==rr&&(n===rr||i);i&&this.element.removeEventListener(this.name,this,n),c&&this.element.addEventListener(this.name,this,a),this._$AH=a}handleEvent(a){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,a):this._$AH.handleEvent(a)}}class Vt{constructor(a,e,n){this.element=a,this.type=6,this._$AN=void 0,this._$AM=e,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(a){ia(this,a)}}const Cl={M:ze,P:Vr,A:Ce,C:1,L:Rt,R:Bt,D:jt,V:ia,I:ha,H:_a,N:Dt,U:Ht,B:Ot,F:Vt},on=Ae.litHtmlPolyfillSupport;on?.(Ea,ha),(Ae.litHtmlVersions??=[]).push("3.3.1");const nn=(r,a,e)=>{const n=e?.renderBefore??a;let i=n._$litPart$;if(i===void 0){const c=e?.renderBefore??null;n._$litPart$=i=new ha(a.insertBefore(Ca(),c),c,void 0,e??{})}return i._$AI(r),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _e=globalThis;class Ja extends pa{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const a=super.createRenderRoot();return this.renderOptions.renderBefore??=a.firstChild,a}update(a){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(a),this._$Do=nn(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ua}}Ja._$litElement$=!0,Ja.finalized=!0,_e.litElementHydrateSupport?.({LitElement:Ja});const cn=_e.litElementPolyfillSupport;cn?.({LitElement:Ja});const Sl={_$AK:(r,a,e)=>{r._$AK(a,e)},_$AL:r=>r._$AL};(_e.litElementVersions??=[]).push("4.2.1");const Te={};function O(r,a){if(typeof document<"u"&&a?.styleSheet){const e=Te[r];Te[r]=a.styleSheet,document.adoptedStyleSheets=[...document.adoptedStyleSheets.filter(n=>n!==e),a.styleSheet]}}function sn(r){const a=Object.values(Te),e=document.adoptedStyleSheets.filter(n=>a.includes(n));if(r.adoptedStyleSheets){const n=e.filter(i=>!r.adoptedStyleSheets.includes(i));r.adoptedStyleSheets=[...r.adoptedStyleSheets,...n]}}const $=u`arc•avatar`,Z=u`arc•modifier`,tr=u`${$}•computed`,Pr=u`${$}•mask`,ln=r=>r?.trim().charAt(0)??void 0,dn=(r,a)=>{let e=0;const n=Math.min(r.length,50);for(let i=0;i<n;i+=1)e=(e+r.charCodeAt(i))%(a??33);return e},pn=(r,a,e)=>a?.length?r?.trim()===""?e||a[0]:a[dn(r,a.length)]||e||a[0]:e,Ft=z(be,["blue","orange","mint","red","yellow","green","maroon","purple"]),un=z(be,["neutral","white","black"]),Qa=z(yr,["lg","md","sm","xs"]),hn=[...Qa,"profile-sm","profile-md","profile-lg"],vn=gt,mn=ft,gn=Qa,fn=Qa,bn=Qa,Ie=u`
...
`,jn=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-articulate arc-aw",color:r?.color||"var(--arc-color-logo-articulate, #000000)","aria-label":r?.["aria-label"]||"Articulate Logo"}),En=r=>{const a={background:["linear-gradient(","to right top, ","var(--arc-color-logo-ai-purple, var(--arc-color-ai-purple-200)), ","var(--arc-color-logo-ai-blue, var(--arc-color-ai-blue-200))",")"].join(""),backgroundClip:"text",color:"transparent",height:"auto",maxHeight:"none"};return(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-ai arc-aw","aria-label":r?.["aria-label"]||"Articulate AI Logo",style:{...r.style,...a}})},_n=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-peek arc-aw",color:r?.color||"var(--arc-color-logo-peek, #497add)","aria-label":r?.["aria-label"]||"Articulate Peek Logo"}),Tn=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-reach arc-aw",color:r?.color||"var(--arc-color-logo-reach, #0081de)","aria-label":r?.["aria-label"]||"Articulate Reach Logo"}),In=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-review arc-aw",color:r?.color||"var(--arc-color-logo-review, #35b062)","aria-label":r?.["aria-label"]||"Articulate Review Logo"}),Ln=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-rise arc-aw",color:r?.color||"var(--arc-color-logo-rise, var(--arc-color-orange-400))","aria-label":r?.["aria-label"]||"Articulate Rise Logo"}),Mn=r=>(0,t.jsx)(B,{...r,icon:"fa-kit fa-product-badge-storyline arc-aw",color:r?.color||"var(--arc-color-logo-storyline, #c560b3)","aria-label":r?.["aria-label"]||"Articulate Storyline Logo"}),Pn=r=>typeof r=="number"?`calc(${r/10}rem * var(--arc-internal-font-size))`:r,B=({children:r,icon:a="fa-regular fa-circle-dashed",color:e,size:n,style:i,...c})=>{const s={...i,"--arc-icon-size":Pn(n),"--arc-icon-color":e},d=!!(c["aria-label"]||c["aria-labelledby"]),l=Cn(a),p=typeof l=="string"&&l.length>0?(0,t.jsx)("span",{className:l}):l;return(0,t.jsx)("span",{"aria-hidden":!d||void 0,...c,"arc-icon":"",style:s,children:r||p})};O("ArcIcon",Sn),B.Articulate=jn,B.AI=En,B.Peek=_n,B.Reach=Tn,B.Review=In,B.Rise=Ln,B.Storyline=Mn,B.SVGArticulate=Le,B.SVGAI=Me,B.SVGPeek=Pe,B.SVGReach=Re,B.SVGReview=Be,B.SVGRise=Oe,B.SVGStoryline=De;const Rn=({children:r,icon:a,color:e,...n})=>(0,t.jsx)("span",{...n,"data-element":"anonymous","data-color":"neutral",children:r||(0,t.jsx)(B,{icon:a})}),Xt="blue",qt="neutral",Bn="fa-solid fa-user arc-aw",He=(0,b.forwardRef)(({children:r,size:a,color:e,isActive:n=!0,isAnonymous:i,alt:c,src:s,name:d,email:l,...p},h)=>{const[v,g]=(0,b.useState)(!1),[f,w]=(0,b.useState)(!1),E=H=>{g(!0),w(!1),p.onLoad?.(H)},j=H=>{g(!1),w(!0),p.onError?.(H)},P=ln(d||l),A=!!P,_=i||(!v||f)&&!A,S=!_&&!!s&&!f||void 0,C=(_&&qt||void 0)??(e||void 0)??pn(String(l||d||void 0),Ft,Xt)??Xt,L={src:s,alt:c,isLoaded:v,hasError:f,onLoad:E,onError:j};return(0,b.useEffect)(()=>{_&&g(!1)},[_]),(0,t.jsx)("span",{...p,ref:h,"arc-avatar":"","data-is-inactive":!n||void 0,"data-size":a,"aria-label":(p.title??d??l)||void 0,children:r||(_?(0,t.jsx)(Rn,{icon:Bn,color:qt}):(0,t.jsxs)(t.Fragment,{children:[S&&(0,t.jsx)(yn,{...L}),A&&(0,t.jsx)($n,{initial:P,color:C})]}))})});O("ArcAvatar",xn);const sr=u`${$}•text`,qr=u`${$}•subtext`,va=u`${$}•gap`,On=u`
@layer arc-components {
...
`,Dn="Anonymous",Ve=({children:r,avatar:a={},subtext:e,size:n,gapSize:i,overflow:c,isStrong:s,...d})=>{const l=a.anonymousName||Dn,p=a.name||a.email||a.src,h=a.name||a.email,v=a.isAnonymous||!p,g=r||v?l:h,f=i!=="inherit"?i:void 0,w=c!=="inherit"?c:void 0;return(0,t.jsxs)("span",{...d,"arc-avatar-text":"","data-gap":f,"data-overflow":w,"is-strong":s?"":void 0,children:[(0,t.jsx)(He,{...a,isAnonymous:v,size:n}),(0,t.jsxs)("span",{"data-element":"text",children:[g,e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("br",{}),(0,t.jsx)("small",{"data-element":"subtext",children:e})]})]})]})};O("ArcAvatarText",On);const Hn=u`
@layer arc-components {
...
`,Vn=({size:r="md",...a})=>(0,t.jsx)("div",{...a,"arc-avatar-pile":"","data-size":r});O("ArcAvatarPile",Hn);const Ta=r=>typeof r=="string"?r:typeof r=="number"?r.toString():Array.isArray(r)?r.map(Ta).join(""):(0,b.isValidElement)(r)?Ta(r.props.children):"",Kt={},Fn=(r="id")=>{const a=(Kt[r]??0)+1;return Kt[r]=a,`${r}-${a}`},Sr=(r,a="id")=>{const e=(0,b.useId)();return r??`${a}-${e}`},Ia=()=>typeof DOMRect<"u"?new DOMRect:{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0,toJSON:()=>({x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})},Jt=[...xe],Nn=[...Za],Fe=z(Q,["common"]),Un=z(Q,["ai","brand"]),Qt=["top-start","top-center","top-end","left-start","right-start","left-center","center","right-center","left-end","right-end","bottom-start","bottom-center","bottom-end"],ro=["ignore","flip"],ao=["compact","comfortable"],T={Threshold:0,StartX:{align:"start",y:"y1",oY:"ch",xMod:-1,yMod:1},StartY:{align:"start",x:"x1",oX:"cw",xMod:-1,yMod:1},CenterX:{align:"center",y:"cy",oY:"z",xMod:-1,yMod:1},CenterY:{align:"center",x:"cx",oX:"z",xMod:1,yMod:-1},EndX:{align:"end",y:"y2",oY:"ch",xMod:1,yMod:-1},EndY:{align:"end",x:"x2",oX:"cw",xMod:1,yMod:-1},Top:{edge:"top",y:"top",pX:"z",pY:"ch",oY:"z",pMod:-1},Bottom:{edge:"bottom",y:"bottom",pX:"z",pY:"ch",oY:"z",pMod:1},Right:{edge:"right",x:"right",pX:"cw",pY:"z",oX:"z",pMod:1},Left:{edge:"left",x:"left",pX:"cw",pY:"z",oX:"z",pMod:-1},Center:{edge:"center",pX:"cw",pY:"ch",pMod:0}},jr=(r,a,e)=>e==="left"&&r.a.left>=r.v.threshold&&r.a.left-r.p.width+a.x>=r.v.threshold||e==="top"&&r.a.top>=r.v.threshold&&r.a.top-r.p.height+a.y>=r.v.threshold||e==="right"&&r.a.right<=r.v.width-r.v.threshold&&r.a.right+r.p.width+a.x<=r.v.width-r.v.threshold||e==="bottom"&&r.a.bottom<=r.v.height-r.v.threshold&&r.a.bottom+r.p.height+a.y<=r.v.height-r.v.threshold,eo=(r,a)=>r.a.top+r.p.height+a.y<=r.v.height-r.v.threshold&&r.a.top>=r.v.threshold,to=(r,a)=>r.a.left+r.p.width+a.x<=r.v.width-r.v.threshold&&r.a.left>=r.v.threshold,oo=(r,a)=>r.a.cy+r.p.ch+a.y<=r.v.height-r.v.threshold&&r.a.cy-r.p.ch+a.y>=r.v.threshold,no=(r,a)=>r.a.cx+r.p.cw+a.x<=r.v.width-r.v.threshold&&r.a.cx-r.p.cw+a.x>=r.v.threshold,io=(r,a)=>r.a.bottom<=r.v.height-r.v.threshold&&r.a.bottom-r.p.height+a.y>=r.v.threshold,co=(r,a)=>r.a.right<=r.v.width-r.v.threshold&&r.a.right-r.p.width+a.x>=r.v.threshold,La={"top-start":{...T.Top,...T.StartY,fitCheck:(r,a)=>jr(r,a,T.Top.edge)&&to(r,a),flip:"bottom-start"},"top-center":{...T.Top,...T.CenterY,fitCheck:(r,a)=>jr(r,a,T.Top.edge)&&no(r,a),flip:"bottom-center"},"top-end":{...T.Top,...T.EndY,fitCheck:(r,a)=>jr(r,a,T.Top.edge)&&co(r,a),flip:"bottom-end"},"right-start":{...T.Right,...T.StartX,fitCheck:(r,a)=>jr(r,a,T.Right.edge)&&eo(r,a),flip:"left-start"},"right-center":{...T.Right,...T.CenterX,fitCheck:(r,a)=>jr(r,a,T.Right.edge)&&oo(r,a),flip:"left-center"},"right-end":{...T.Right,...T.EndX,fitCheck:(r,a)=>jr(r,a,T.Right.edge)&&io(r,a),flip:"left-end"},center:{...T.Center,...T.CenterX,...T.CenterY,fitCheck:(r,a)=>r.a.cx-r.p.cw+a.x>=r.v.threshold&&r.a.cx+r.p.cw+a.x<=r.v.width-r.v.threshold&&r.a.cy-r.p.ch+a.y>=r.v.threshold&&r.a.cy+r.p.ch+a.y<=r.v.height-r.v.threshold,flip:"center"},"bottom-start":{...T.Bottom,...T.StartY,fitCheck:(r,a)=>jr(r,a,T.Bottom.edge)&&to(r,a),flip:"top-start"},"bottom-center":{...T.Bottom,...T.CenterY,fitCheck:(r,a)=>jr(r,a,T.Bottom.edge)&&no(r,a),flip:"top-center"},"bottom-end":{...T.Bottom,...T.EndY,fitCheck:(r,a)=>jr(r,a,T.Bottom.edge)&&co(r,a),flip:"top-end"},"left-start":{...T.Left,...T.StartX,fitCheck:(r,a)=>jr(r,a,T.Left.edge)&&eo(r,a),flip:"right-start"},"left-center":{...T.Left,...T.CenterX,fitCheck:(r,a)=>jr(r,a,T.Left.edge)&&oo(r,a),flip:"right-center"},"left-end":{...T.Left,...T.EndX,fitCheck:(r,a)=>jr(r,a,T.Left.edge)&&io(r,a),flip:"right-end"}},wr={popover:Jt[0],anchorAt:Qt[10],boundary:ro[0],variant:Fe[0],isInverse:!1,hasTail:!1,tailSize:10,threshold:0,offset:0,density:ao[0]},Yn=(r=wr.threshold)=>({threshold:r,width:document.documentElement.clientWidth,height:document.documentElement.clientHeight,scrollX:window.scrollX,scrollY:window.scrollY,left:window.scrollX,top:window.scrollY,right:window.scrollX+document.documentElement.clientWidth,bottom:window.scrollY+document.documentElement.clientHeight}),so=r=>({...JSON.parse(JSON.stringify(r)),cw:r.width/2,ch:r.height/2,cx:r.left+r.width/2,cy:r.top+r.height/2,x1:r.left,x2:r.left+r.width,y1:r.top,y2:r.top+r.height,z:0}),Wn=(r,a,e=wr.offset,n=wr.tailSize,i=wr.threshold)=>({a:so(r?.getBoundingClientRect()??Ia()),p:so(a?.getBoundingClientRect()??Ia()),o:e,v:Yn(i),t:n}),lo=(r,a,e)=>({x:["left","right"].includes(r)?a*e:0,y:["top","bottom"].includes(r)?a*e:0}),Zn=(r,a)=>[...Object.keys(La)].filter(e=>ea(e,r)&&ea(a.align,"center")?!e.includes("center"):e).sort((e,n)=>{const i=Ga(La[e].edge,a.edge),c=Ga(La[n].edge,a.edge),s=i?-1:1;return Ga(i,c)?0:s}),po=({anchorAt:r,measurements:a})=>{const e=La[r],n=lo(e.edge,a.o,e.pMod);return{cx:a.a.cx,cy:a.a.cy,offsets:n,config:e}},Gn=({anchorAt:r,measurements:a})=>{const{offsets:e,config:n}=po({anchorAt:r,measurements:a});return n.fitCheck(a,e)?r:[n.flip,...Zn(r,n)].find(i=>{const c=La[i],s=lo(c.edge,a.o,c.pMod);return c.fitCheck(a,s)})??r},Fr=(r,a="px")=>`${Math.round(Number(r))}${a}`,Ne=({anchorElement:r,popoverElement:a,anchorAt:e=wr.anchorAt,boundary:n,offset:i,tailSize:c,threshold:s=T.Threshold,isFixed:d=!1})=>{const l=e,p=Wn(r,a,i,c,s),h=n==="flip"?Gn({anchorAt:l,measurements:p}):l,{cx:v,cy:g}=po({anchorAt:h,measurements:p}),f={cx:v,cy:g},w=d?0:window.scrollX,E=d?0:window.scrollY,j=r?.dataset?.layout==="icon"||p.t>0||!e?.includes("-center")&&(e?.includes("left-")||e?.includes("right-"));return{anchorAt:h,vars:{"--js-cx":Fr(f.cx+w),"--js-cy":Fr(f.cy+E),"--js-w":Fr(p.a.width),"--js-h":Fr(p.a.height),"--js-cw":Fr(p.a.cw),"--js-ch":Fr(p.a.ch),"--js-o":Fr(p.o),"--js-t":Fr(p.t,""),"--js-i":j?"1":"0","--js-m":Fr(xt(p.t,p.a.height,p.a.cw))}}},uo=(r,a=150)=>{let e=!1,n=0,i=0,c=0,s=null,d=null,l=null;const p=h=>{if(s!==null)return s;let v=h;for(;v&&v!==document.documentElement;){const{position:g}=window.getComputedStyle(v);if(g==="fixed"||g==="sticky")return s=!0,!0;v=v.parentElement}return s=!1,!1};return()=>{if(!r)return{isFixed:!1,rect:Ia()};r!==l&&(s=null,l=r,c=0);const h=Math.round(performance.now());if(h-c<=a)return{isFixed:e,rect:d??Ia()};c=h,d=r.getBoundingClientRect();const v=d.top!==n||d.left!==i;return n=d.top,i=d.left,e=(e?!0:p(r))||!v,{isFixed:e,rect:d}}},ho=(r,a=1/0,e=" ")=>[...r].flat(a)?.filter(Boolean)?.join(e),Xn=u`
@layer arc-components {
...
`,Ue=(0,b.forwardRef)(({progress:r,...a},e)=>(0,t.jsxs)("svg",{...a,ref:e,viewBox:"0 0 100 100","arc-spinner":"",style:{"--arc-spinner-progress":r??""},children:[(0,t.jsx)("circle",{"arc-spinner-circle":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"}),(0,t.jsx)("circle",{"arc-spinner-progress":"",cx:"50%",cy:"50%",r:"45%",strokeWidth:"12.5%",pathLength:"1"})]}));Ue.displayName="ArcSpinner",O("ArcSpinner",Xn);const qn=(...r)=>console.log(...r),vo=(...r)=>console.warn(...r),Kn=(...r)=>console.error(...r),Nr=u`arc•icon•text`,G=u`${Nr}•icon`,Y=u`${Nr}•text`,ma=u`${Nr}•subtext`,Ur=u`${Nr}•gap`,Jn=u`
...
`,ei=z(Q,["inherit","primary","secondary","inverse","brand","info","success","warning","critical"]),Er=({children:r,layout:a="gutter",size:e="inherit",variant:n="inherit",tag:i="span",icon:c,text:s,subtext:d,overflow:l,iconSize:p,gapSize:h,isFlipped:v=!1,isStrong:g=!1,...f})=>{const w=r||s,E=!!c,j=!!w,P=a==="gutter",A=a==="inline",_=E&&(!v||P),S=E&&j&&v&&A,C=!!p&&p!=="inherit",L=C&&$e.includes(p)?p:void 0,H=C&&!$e.includes(p)?p:void 0,J=h!=="inherit"?h:void 0,X=l!=="inherit"?l:void 0,V=Gt(c);return(0,t.jsxs)(i,{...f,"arc-icon-text":"","data-variant":n,"data-layout":a,"data-overflow":X,"data-size":e,"data-gap":J,"icon-size":L,"is-flipped":v?"":void 0,"is-strong":g?"":void 0,children:[_&&(0,t.jsx)("span",{"data-element":"icon",children:typeof V=="string"?(0,t.jsx)(B,{icon:V,size:H}):V}),j&&(0,t.jsxs)("span",{"data-element":"text",children:[w,!!d&&(P?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("br",{}),(0,t.jsx)("small",{"data-element":"subtext",children:d})]}):(0,t.jsxs)(t.Fragment,{children:[" ",(0,t.jsx)("span",{"data-element":"subtext",children:d})]}))]}),S&&(0,t.jsx)("span",{"data-element":"icon",children:typeof V=="string"?(0,t.jsx)(B,{icon:V,size:H}):V})]})};O("ArcIconText",ai);const Tr={...wr,popover:"manual",anchorAt:"top-center",boundary:"flip",variant:"common",tailSize:8,offset:4,isInverse:!0,isStrong:!0,hasTail:!0,isEnabled:!0};let re=!1;const ti=100,oi=100;let Ye=!0,We=null;const ni=typeof CSS<"u"&&typeof CSS.supports=="function"&&CSS.supports("selector(:focus-visible)"),ii=r=>r instanceof Element?ni?r.matches(":focus-visible")===!0:Ye:!1,Ze=new WeakMap,Ge=new WeakMap,ae=(r,a)=>{const e=r.get(a);e!=null&&(clearTimeout(e),r.delete(a))},mo=(r,a,e,n)=>{const i=window.setTimeout(()=>{n(),r.delete(a)},e);r.set(a,i)},go="[aria-describedby]",ci=r=>typeof r=="object"&&r!==null&&r.hasAttribute?.("popover")===!0,fo=r=>r instanceof HTMLElement&&r.getAttribute("role")==="tooltip"&&ci(r),si=r=>!!r&&(r.tagName==="LABEL"||r.hasAttribute("arc-label")),li=r=>r?.match(/\S+/g)??[],Xe=r=>{if(typeof document>"u")return null;const a=document.querySelector(`[aria-describedby~="${r}"]`);return a?a.closest("label,[arc-label]")??a:null},di=r=>{if(!(r instanceof Element))return null;const a=r.closest?.(go);if(a){const n=a.getAttribute("aria-describedby")??"";if(n)return{anchor:a.closest?.("label,[arc-label]")??a,tooltipId:n}}let e=r;for(;e;){if(si(e)){const n=e.querySelector?.(go),i=n?.getAttribute?.("aria-describedby")??"";if(n&&i)return{anchor:e,tooltipId:i}}e=e.parentElement}return null},pi=r=>{if(!(r instanceof Element))return null;const a=r.closest?.('[role="tooltip"][popover]')??null;return a instanceof HTMLElement?a:null},ui=r=>r?.id?Xe(r.id):null,hi=r=>{const a=pi(r),e=di(r);if(!e&&a){const d=ui(a);return!d||!a.id?null:{anchor:d,tooltip:a}}if(!e)return null;const{anchor:n,tooltipId:i}=e;if(!i)return null;const c=li(i),s=a??c.map(d=>document.getElementById(d)).find(d=>fo(d))??null;return fo(s)?{anchor:n,tooltip:s}:null},vi=(r,a,e)=>{const n=e instanceof Element?e:null;if(!n)return!1;const i=r===n||r.contains(n),c=a===n||a.contains(n);return i||c},mi=(r,a)=>{if(ae(Ge,r),ae(Ze,r),!a){r.isConnected&&r.showPopover?.();return}mo(Ze,r,ti,()=>{r.isConnected&&r.showPopover?.()})},gi=(r,a)=>{if(ae(Ze,r),ae(Ge,r),!a){r.isConnected&&r.hidePopover?.();return}mo(Ge,r,oi,()=>{r.isConnected&&r.hidePopover?.()})},Ma=(r,a,e,n)=>{const i=hi(a);if(!i)return;const{anchor:c,tooltip:s}=i;if(r){mi(s,n);return}vi(c,s,e)||gi(s,n)};let ee=null,te=null,oe=null,ne=null,ie=null,ce=null,ga=null;const bo=()=>{re||typeof document>"u"||(ce=r=>{Ye=!1,We=r.target},ga=()=>{We=null},ee=r=>Ma(!0,r.target,void 0,!0),te=r=>{ii(r.target)&&Ma(!0,r.target,void 0,!1)},oe=r=>Ma(!1,r.target,r.relatedTarget,!0),ne=r=>{const a=r.relatedTarget??We;Ma(!1,r.target,a,!1)},ie=r=>{r.key==="Tab"&&(Ye=!0),r.key==="Escape"&&Ma(!1,r.target,void 0,!1)},document.addEventListener("pointerdown",ce),document.addEventListener("pointerup",ga),document.addEventListener("pointercancel",ga),document.addEventListener("pointerover",ee),document.addEventListener("focusin",te),document.addEventListener("pointerout",oe),document.addEventListener("focusout",ne),document.addEventListener("keydown",ie),re=!0)},fi=()=>{if(!re||typeof document>"u")return;[["pointerdown",ce],["pointerup",ga],["pointercancel",ga],["pointerover",ee],["focusin",te],["pointerout",oe],["focusout",ne],["keydown",ie]].forEach(([a,e])=>{e&&document.removeEventListener(a,e)}),ee=null,te=null,oe=null,ne=null,ie=null,ce=null,ga=null,re=!1},bi=u`
@layer arc-components {
  [arc-tooltip] {
...
`,xo=(0,b.forwardRef)(({id:r,children:a,slot:e,isEnabled:n=Tr.isEnabled,anchorAt:i=Tr.anchorAt,boundary:c=Tr.boundary,hasTail:s=Tr.hasTail,tailSize:d=Tr.tailSize,offset:l=Tr.offset,isStrong:p=Tr.isStrong,text:h,subtext:v,icon:g,isFlipped:f,...w},E)=>{if(n)try{bo()}catch{}const j=Sr(r,"arc-tooltip"),P=H=>typeof H=="object"&&H!==null&&"tabIndex"in H,A=a,_=!!w.alternateAnchor;let S=null;(0,b.isValidElement)(A)?S=n?(0,b.cloneElement)(A,{"aria-describedby":j,...P(A.props)&&A.props.tabIndex!=null?{}:{tabIndex:0}}):A:!_&&typeof console<"u"&&vo("ArcTooltip expects a single ReactElement child as the trigger.");const C=(0,b.useMemo)(()=>()=>Xe(j),[j]),L=w?.isInverse??Tr.isInverse;return(0,t.jsxs)(t.Fragment,{children:[S,n&&(0,t.jsxs)(Ba,{...w,"arc-tooltip":"",role:"tooltip",id:j,ref:E,popover:Tr.popover,anchorAt:i,boundary:c,variant:Tr.variant,isInverse:L,hasTail:s,tailSize:d,offset:l,hidePopoverButton:!0,alternateAnchor:w.alternateAnchor??C,children:[h&&(0,t.jsx)(Er,{"arc-tooltip-content":"",text:h,subtext:v,icon:g,isFlipped:f,isStrong:p,size:"inherit",variant:"inherit"}),e&&(0,t.jsx)("span",{"arc-tooltip-slot-content":"",children:e})]})]})});O("ArcTooltip",bi);const xi=z(fe,["circle","square","narrow"]),$i=z(yr,["xxl","xl","lg","md","sm"]),yi=z(Hr,["hug","fill","icon"]),wi=z(Q,["common","ai","critical"]),$o=z(Q,["primary","secondary","tertiary","critical-primary","critical-secondary","ai-primary","ai-secondary","primary-inverse","secondary-inverse","tertiary-inverse"]),ki=z(ht,["primary","secondary","tertiary","plain"]),Ai=[...Za],F=u`arc•modifier`,o=u`arc•button`,D=u`${o}•spinner`,lr=u`${o}•icon`,M=u`${o}•computed`,zi=u`
  &[data-size=xxl] {
...
`,yo=(0,t.jsx)(Ue,{}),ur=(0,b.forwardRef)(({children:r,disabled:a,...e},n)=>{const i=(0,b.useRef)(null),{iconEnd:c,iconStart:s,icon:d,text:l,isActive:p,isDisabled:h,isProcessing:v,isProcessingWithText:g,hasLargeIcon:f,tag:w,href:E,type:j,title:P,layout:A,shape:_,size:S="lg",variant:C="common",hierarchy:L="primary",isInverse:H=!1,_isCustom:J,...X}=e,V=w??(E?"a":"button"),br=V==="button"?j||"button":void 0,kr=A==="icon",Ar=g||v||h||a,Ir=X?.["aria-disabled"]||Ar||void 0,q=!kr&&(r||l),xr=g&&yo||s||d,ra=!kr&&(g&&!(s||d)?void 0:c),Lr=(v||g&&kr)&&yo,Zr=C&&$o.includes(C),Gr=(()=>{if(Zr||!["common","critical","ai"].includes(C))return C;const Xr=L||"primary";return C==="common"?H?`${Xr}-inverse`:Xr:`${C}-${Xr}`})(),{tooltip:Mr,...Dr}=X,zr=typeof Mr=="string"?Mr:void 0,R=e.tooltip??zr,cr=!!R,hr=typeof R=="string"?{text:R}:R,er=X["aria-describedby"],W=(0,b.useRef)(void 0),vr=Sr(void 0,"arc-tooltip");cr&&!W.current&&(W.current=e.id?`${e.id}-tooltip`:vr);const Cr=cr?ho([er,W.current]):er,{popoverTarget:$r,popoverTargetAction:aa,...he}=Dr;let ve={popoverTarget:$r||void 0,popoverTargetAction:aa||void 0};return b.version.startsWith("18")&&(ve={popovertarget:$r||void 0,popovertargetaction:aa||void 0}),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(V,{...he,...ve,ref:Xr=>{i.current=Xr,bt(n,Xr)},"arc-button":J?"custom":"",disabled:!E&&Ar||void 0,href:E||void 0,title:cr?void 0:P||void 0,type:br,"data-layout":A,"data-shape":J?void 0:_,"data-size":J?void 0:S,"data-variant":J?void 0:Gr,"has-large-icon":f?"":void 0,"is-active":p?"":void 0,"is-processing":v||g&&kr?"":void 0,"is-processing-with-text":g&&!kr?"":void 0,"is-disabled":Ar||Ir?"":void 0,"aria-disabled":Ir,"aria-describedby":Cr||void 0,children:[(0,t.jsxs)("span",{"arc-button-content":"",children:[!!xr&&(0,t.jsx)(B,{"arc-button-icon":"",icon:xr}),!!q&&(0,t.jsx)("span",{"arc-button-label":"",children:q}),!!ra&&(0,t.jsx)(B,{"arc-button-icon":"",icon:ra})]}),Lr]}),cr&&(0,t.jsx)(xo,{...hr,id:W.current,alternateAnchor:hr?.alternateAnchor??(()=>i.current)})]})});ur.displayName="ArcButton",O("ArcButton",Li);const Pa=(0,b.forwardRef)((r,a)=>(0,t.jsx)(ur,{...r,ref:a,"arc-popover-button":""})),wo=({isInverse:r=!1,isOpen:a,...e})=>(0,t.jsx)(ur,{...e,icon:"fa-regular fa-xmark",text:"Dismiss",layout:"icon",shape:"square",size:"sm",variant:"common",hierarchy:"tertiary",isInverse:r,"arc-popover-dismiss":""}),Mi=({children:r,showDismiss:a,dismissProps:e,tag:n="header",...i})=>(0,t.jsxs)(n,{...i,"arc-popover-header":"",children:[r,a&&(0,t.jsx)(wo,{...e})]}),Pi=({tag:r="article",...a})=>(0,t.jsx)(r,{...a,"arc-popover-body":""}),Ri=({showDivider:r,tag:a="footer",...e})=>(0,t.jsx)(a,{...e,"arc-popover-footer":"","has-divider":r?"":void 0}),Bi=r=>(0,t.jsx)("span",{...r,"arc-popover-tail":""});Pa.displayName="ArcPopoverButton";const m=u`arc•popover`,I=u`${m}•space`,se=u`${m}•font`,mr=u`${m}•shift`,fa=u`${m}•offset`,Yr=u`${m}•outline`,Rr=u`${m}•header`,_r=u`${m}•body`,or=u`${m}•footer`,x=u`${m}•tail`,Oi=u`
  --${m}-position: absolute;
  ...
  /* offset */
  --${fa}-x: calc(var(--js-cw) + var(--js-o) + var(--arc-popover-nudge, 0em));
  --${fa}-y: calc(var(--js-ch) + var(--js-o) + var(--arc-popover-nudge, 0em));
...
`,Ra={SETUP:Oi,POSITION:Di,VARIANTS:Hi,DENSITIES:Vi,ELEMENTS:Fi},Ni=u`
@layer arc-components {
  [arc-popover] {
    ${Ra.SETUP}
    ${Ra.POSITION}
...
`,Ui=(r,a)=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a??"toggle"]()},ko=(0,b.forwardRef)(({children:r,popover:a=wr.popover,alternateAnchor:e,alternateAnchorId:n,anchorProps:i,anchorAt:c,boundary:s,density:d=wr.density,variant:l=wr.variant,isInverse:p,hasTail:h,tailSize:v=wr.tailSize,offset:g=wr.offset,hidePopoverButton:f,headerSlot:w,showDismiss:E,dismissProps:j,footerSlot:P,showFooterDivider:A,tag:_="div",contentTag:S="div",onToggle:C,...L},H)=>{const J=(0,b.useRef)(null),X=(0,b.useRef)(null);(0,b.useImperativeHandle)(H,()=>X.current);const[V,br]=(0,b.useState)(!1),[kr,Ar]=(0,b.useState)(c||wr.anchorAt),[Ir,q]=(0,b.useState)({}),[xr,ra]=(0,b.useState)(0),[Lr,Zr]=(0,b.useState)(h?g??0:0),Gr=(0,b.useMemo)(()=>p&&[...Fe].includes(l),[l,p]),Mr=(0,b.useMemo)(()=>({popoverTarget:L.id,"aria-haspopup":!0,"aria-controls":L.id,"aria-expanded":V}),[L.id,V]),Dr=(0,b.useMemo)(()=>({isInverse:Gr,isOpen:V,"aria-label":"Dismiss",...Mr,...j}),[j,Gr,V,Mr]),zr=(0,b.useMemo)(()=>({ref:J,...Mr,...i}),[J,i,Mr]),pr=(0,b.useCallback)(()=>typeof e=="function"?e(zr):n||typeof e=="string"?document.getElementById(n||String(e)):J.current,[n,e,zr]),R=(0,b.useCallback)(({...W})=>{Ar(W.anchorAt),q(W.vars)},[Ar,q]);(0,b.useEffect)(()=>{const W=h?v??0:0,vr=Number(g??0)+W*(Math.sqrt(2)/2);ra(W),Zr(vr)},[h,v,g]);const cr=(0,b.useMemo)(()=>uo(pr()),[pr]),{isFixed:hr,rect:er}=(0,b.useMemo)(()=>cr(),[cr]);return(0,b.useEffect)(()=>{const W=X?.current,vr=pr();if(!vr||!V)return;let Cr=null,$r=null;const aa=()=>{$r&&$t({a:er,b:Cr})?(Cr=er,R(Ne({anchorElement:vr,popoverElement:W,anchorAt:c,boundary:s,offset:Lr,tailSize:xr,isFixed:hr}))):$r=null,$r=requestAnimationFrame(aa)};return $r=requestAnimationFrame(aa),()=>{$r&&cancelAnimationFrame($r)}},[X,pr,hr,er,V,c,s,Lr,xr,R]),(0,b.useEffect)(()=>{const W=X.current;if(!W)return;const vr=Cr=>{const{newState:$r}=Cr;br($r==="open"),R(Ne({anchorElement:pr(),popoverElement:W,anchorAt:c,boundary:s,offset:Lr,tailSize:xr,isFixed:hr})),C?.(Cr)};return W.addEventListener("toggle",vr),()=>W.removeEventListener("toggle",vr)},[X,C,pr,hr,er,c,s,Lr,xr,R]),(0,t.jsxs)(t.Fragment,{children:[!((n||e)&&f)&&(0,t.jsx)(Pa,{...zr}),(0,t.jsxs)(_,{...L,role:L.role??"dialog","arc-popover":kr,ref:X,popover:a,boundary:s,variant:l,density:d,"is-fixed":hr?"":void 0,"is-inverse":Gr?"":void 0,"has-tail":h?"":void 0,style:{...L.style,...Ir},children:[h&&(0,t.jsx)(Bi,{}),(0,t.jsxs)(S,{"arc-popover-content":"",children:[!!w&&(0,t.jsx)(Mi,{showDismiss:E,dismissProps:Dr,children:w}),w||P?(0,t.jsx)(Pi,{children:r}):r,!!P&&(0,t.jsx)(Ri,{showDivider:A,children:P})]}),E&&!w&&(0,t.jsx)(wo,{...Dr})]})]})});ko.displayName="ArcPopover";const qe=ko;qe.handlePopover=Ui,qe.Button=Pa;const Ba=qe;O("ArcPopover",Ni);const Yi=u`
@layer arc-components {
...
`,Wi=r=>(0,t.jsx)("ul",{...r,"data-element":"list"}),Zi=r=>(0,t.jsx)("li",{...r,"data-element":"list-item"}),Gi=({count:r,anchorId:a,overflowId:e,shouldShowOverflow:n,...i})=>(0,t.jsx)(He,{title:`+${r}`,children:(0,t.jsx)(Ba.Button,{...i,id:a,popoverTarget:e,text:`+${r}`,variant:"common",hierarchy:"primary",disabled:!n,"data-element":"counter","data-color":"black","data-num-length":r?.toString().length})}),Xi=({children:r,id:a,size:e="sm",overflowCount:n=0,shouldShowOverflow:i=!1,anchorAt:c="bottom-end",boundary:s="flip",...d})=>{const l=Math.min(n,999),p=Sr(a,"arc-avatar-overflow"),h=(0,b.useMemo)(()=>`${p}-anchor`,[p]),v=(0,b.useMemo)(()=>b.Children.toArray(r),[r]);return(0,t.jsxs)(t.Fragment,{children:[l>0&&(0,t.jsx)(Gi,{count:l,anchorId:h,overflowId:p,shouldShowOverflow:i}),i&&l>0&&(0,t.jsx)(Ba,{...d,"arc-avatar-overflow":"",id:p,anchorAt:c,boundary:s,alternateAnchorId:h,hidePopoverButton:!0,variant:"common",isInverse:!0,"data-size":e,children:(0,t.jsx)(Wi,{children:v.map((g,f)=>(0,t.jsx)(Zi,{children:g},f))})})]})};O("ArcAvatarOverflow",Yi);const qi=u`
@layer arc-components {
...
`,tc=z(yr,["inherit","lg","md","sm"]),oc=z(Q,["neutral","brand","critical","warning","success","inverse"]),nc=z(fe,["square","circle"]),ic=({children:r,text:a,variant:e="neutral",size:n="inherit",shape:i="square",...c})=>{const s=r||a;return(0,t.jsx)("span",{...c,"arc-badge-count-wrapper":"",children:(0,t.jsx)("span",{"arc-badge-count":"","data-variant":e,"data-shape":i,"data-size":n,children:s})})};O("ArcBadgeCount",ec);const cc=u`
@layer arc-components {
...
`,sc=z(Hr,["hug","fill"]),ca=({layout:r,...a})=>(0,t.jsx)("label",{...a,"arc-label":"","data-layout":r});O("ArcLabel",cc);const lc=u`
@layer arc-components {
...
`,sa=r=>(0,t.jsx)("span",{...r,"arc-label-content":""});O("LabelContent",lc);const dc={checkbox:"checkbox",radio:"radio",switch:"radio"},Oa=({id:r,indeterminate:a,type:e,onChange:n,...i})=>{const c=e==="checkbox"&&!!a,s=(0,b.useRef)(null),d=Sr(r,`arc-${e}`),l=p=>h=>{if(!(h?.target instanceof HTMLInputElement))return;const v={checked:h?.target.checked,indeterminate:h?.target?.indeterminate,name:h?.target?.name,value:i?.value};p?.(v,h)};return(0,b.useEffect)(()=>{s.current?.type==="checkbox"&&(s.current.indeterminate=!!a)},[a]),(0,t.jsx)("input",{...i,id:d,ref:s,type:dc[e],"arc-input-type":e,"aria-disabled":i?.disabled||void 0,"data-is-disabled":i?.disabled||void 0,"data-is-checked":i?.checked||void 0,"data-is-indeterminate":c||void 0,onChange:l(n)})},pc=u`
@layer arc-components {
...
`,le=({type:r,...a})=>(0,t.jsx)("span",{"arc-input-mask-wrapper":"",children:(0,t.jsx)("span",{...a,"arc-input-mask":r})});O("ArcBooleanInputMask",pc);const uc=u`
@layer arc-components {
...
`,hc=z(Hr,["hug","fill"]),vc=z(yr,["inherit","md","sm"]),mc=z(Q,["primary","secondary"]),Ao=({children:r,label:a,layout:e,size:n="md",variant:i="primary",useMask:c=!0,...s})=>{const{className:d,title:l,...p}=s,h={className:d,title:l},v=r??a,g=(0,t.jsx)(Oa,{...p,type:"checkbox"}),f=c&&(0,t.jsxs)(le,{type:"checkbox",children:[g,(0,t.jsx)(B,{icon:p?.indeterminate?"fa-solid fa-minus arc-fw":"fa-solid fa-check arc-fw"})]}),w=!!v&&(0,t.jsxs)(ca,{layout:e,children:[f||g,(0,t.jsx)(sa,{children:v})]});return(0,t.jsx)("span",{...h,"arc-checkbox":"","data-size":n,"data-variant":i,children:w||f||g})};O("ArcCheckbox",uc);const gc=u`
@layer arc-components {
...
`,fc=z(Hr,["hug","fill"]),bc=z(yr,["lg","md"]),xc=({children:r,label:a,icon:e,...n})=>{const i=r||(0,t.jsx)(Er,{icon:e,text:a});return(0,t.jsx)("li",{"arc-checkbox-bar-option":"","data-is-checked":n?.checked||void 0,children:(0,t.jsx)(Ao,{...n,label:i,layout:"fill",useMask:!1})})},$c=({children:r,size:a="lg",layout:e="hug",...n})=>(0,t.jsx)("ul",{...n,"arc-checkbox-bar":"","data-size":a,"data-layout":e,role:"group",children:r});O("ArcCheckboxBar",gc);const yc=u`arc•menu`,ba=u`${yc}•item`,wc=u`
@layer arc-components {
...
`,kc=r=>[{test:()=>!!r.variant,value:r.variant},{test:()=>!!r.icon&&typeof r.subtext<"u",value:"icon-text-detail"},{test:()=>!!r.icon,value:"icon-text"},{test:()=>!!r.avatar&&typeof r.subtext<"u",value:"user-detail"},{test:()=>!!r.avatar,value:"user"},{test:()=>typeof r.subtext<"u",value:"text-detail"},{test:()=>!0,value:"text"}],Ac={divider:"separator","section-label":"presentation","icon-text-detail":"menuitem","icon-text":"menuitem","user-detail":"menuitem",user:"menuitem","text-detail":"menuitem",text:"menuitem"},la={layout:"gutter",variant:"inherit",overflow:"truncate",gapSize:"md",size:"md"},zc=({icon:r,...a})=>{const e=r&&typeof r=="string"?`${r.replace(" fa-fw","")} arc-fw`:r;return{divider:(0,t.jsx)("hr",{}),"section-label":(0,t.jsx)(Er,{...a,...la,icon:e,size:"sm",isStrong:!0}),"icon-text":(0,t.jsx)(Er,{...a,...la,icon:e}),"icon-text-detail":(0,t.jsx)(Er,{...a,...la,icon:e,isStrong:!0}),text:(0,t.jsx)(Er,{...a,...la}),"text-detail":(0,t.jsx)(Er,{...a,...la,subtext:a.subtext??"sub",isStrong:!0}),user:(0,t.jsx)(Ve,{...a,...la,size:"sm"}),"user-detail":(0,t.jsx)(Ve,{...a,...la,size:"md",isStrong:!0})}},Cc=r=>r?.role??Ac[Da(r)]??"menuitem",Da=r=>kc(r)?.find(({test:a})=>a())?.value??"text",zo=r=>a=>zc(a)[r],Sc=(r,a,e,n)=>{let i=1,c=r;const s=l=>l>=e?0:l+1,d=l=>l<=0?e:l-1;for(;i<=e;){const l=s(c),p=d(c),h={previous:a==="previous"?p:c,actual:c,next:a==="next"?l:c}[a];if(n(h))return h;c=h,i+=1}return-1},jc=({items:r,filterText:a,renderItem:e,isVisible:n,...i})=>{const c=(0,b.useRef)(null),s=(0,b.useRef)([]),[d,l]=(0,b.useState)(-1),[p,h]=(0,b.useState)(!1),[v,g]=(0,b.useState)(Math.max(r.length-1,0));(0,b.useEffect)(()=>{n&&c.current&&(s.current=Array.from(c.current.querySelectorAll("[arc-button=custom]")))},[n,r]);const f=(0,b.useCallback)(S=>s.current[S]||null,[]),w=(0,b.useCallback)((S,C)=>{const L=Sc(S,C,v,f);l(L),f(L)?.focus()},[v,f]),E=(0,b.useCallback)((S,C)=>()=>{!p&&C&&w(S,"actual")},[p,w]),j={ArrowUp:S=>w(S,"previous"),ArrowDown:S=>w(S,"next"),Home:()=>w(0,"actual"),End:()=>w(v,"actual")},P=S=>C=>{Object.keys(j).includes(C.key)&&(h(!0),C.stopPropagation(),C.preventDefault(),j[C.key](S))},A=(0,b.useMemo)(()=>{const S=a?r.filter(C=>Object.values(C).some(L=>L===a)):r;return g(Math.max(S.length-1,0)),S},[r,a]),_=(0,b.useMemo)(()=>A.map(({itemId:S,role:C,...L},H)=>{const J=Da(L)||"",X=C||Cc(L)||"menuitem",V=H===d;return(0,t.jsx)("li",{"arc-menu-item":J,role:X,onMouseEnter:E(H,!!L.onClick),children:e?.(L,H,{filterText:a,isCurrent:V})},S)}),[d,a,A,e,E]);return(0,b.useEffect)(()=>{n&&w(-1,"next")},[n,w]),(0,t.jsx)("ul",{...i,ref:c,"arc-menu":"",role:"menu",onKeyDown:P(d),onMouseLeave:()=>l(-1),onMouseMove:()=>h(!1),tabIndex:n?0:-1,children:_})};O("ArcMenu",wc);const Co=r=>{const{startSlot:a,endSlot:e,onClick:n,href:i,target:c,containerProps:s,isDisabled:d,"aria-disabled":l,tooltip:p,...h}=r,v=Da(h),g=zo(v),f=l??d,w=v==="divider",E=i||n,j=!w,P=j&&a?"":void 0,A=j&&e?"":void 0,_=S=>{f||(S.currentTarget.closest("[arc-popover]")?.hidePopover(),n?.(S.nativeEvent))};return E?(0,t.jsxs)(ur,{...s,tooltip:p,href:i,target:c,"aria-disabled":f?"true":void 0,_isCustom:!0,"arc-dropdown-item":v??"","has-start-slot":P,"has-end-slot":A,onClick:_,children:[j&&a,(0,t.jsx)(g,{...h,"is-item-content":"interactive"}),j&&e]}):(0,t.jsxs)("div",{...s,"arc-dropdown-item":v??"","has-start-slot":P,"has-end-slot":A,children:[j&&a,(0,t.jsx)(g,{...h,"is-item-content":"inert"}),j&&e]})},Ec=u`arc•dropdown`,_c=u`${Ec}•menu`,K=u`${_c}•item`,Tc=u`
@layer arc-components {
...
`,So=(0,b.forwardRef)((r,a)=>(0,t.jsx)(Pa,{...r,ref:a,"arc-dropdown-menu-button":""})),Ke=r=>{const{items:a,renderItem:e,...n}=r,[i,c]=(0,b.useState)(!1),s=(0,b.useCallback)((...l)=>e?.(...l)||(0,t.jsx)(Co,{...l[0]}),[e]),d=l=>{c(l.newState==="open"),r?.onToggle?.(l)};return(0,t.jsx)(Ba,{...n,"arc-dropdown":"",variant:"common",onToggle:d,children:(0,t.jsx)(jc,{"arc-dropdown-menu":"",items:a??[],renderItem:s,isVisible:i})})};So.displayName="ArcDropdownButton",Ke.Button=So,Ke.Item=Co,O("ArcDropdownMenu",Tc);const Ic=r=>(0,t.jsx)(ur,{...r,layout:"icon",size:"md",variant:"common",hierarchy:"tertiary"}),gr=u`arc•link`,nr=u`${gr}•icon`,ir=u`${gr}•text`,Lc=u`
@layer arc-components {
...
`,Mc=z(Q,["inherit","primary","secondary","inverse"]),Pc=({children:r,layout:a="gutter",size:e="inherit",variant:n="inherit",tag:i="a",href:c,icon:s,text:d,overflow:l,iconSize:p,gapSize:h,isFlipped:v,isDisabled:g,...f})=>(0,t.jsx)(i,{...f,href:g?void 0:c,"arc-link":"","data-variant":n,"aria-disabled":g,"data-is-disabled":g?"":void 0,children:r||(0,t.jsx)(Er,{icon:s,text:d,overflow:l,iconSize:p,gapSize:h,size:e,layout:a,isFlipped:v})});O("ArcLink",Lc);const Rc=z(Q,["common"]),Bc=z(Q,["common","critical"]),Oc=z(Q,["common","brand","info","success","warning","error","processing"]),Dc=["auto","dark","light","none"],Hc=["auto","all","top-bottom","left-right","left-right-top","left-right-bottom","top-bottom-left","top-bottom-right","none"],Vc=z(yr,["xl","lg","md","sm","custom","fullscreen"]),Fc=["cancel","escape","outside","button:dismiss","button:back","button:primary","button:secondary","button:tertiary","confirm:discard","confirm:cancel"],Ha=u`arc•button•bar`,Nc=u`
@layer arc-components {
...
`,Je=({children:r,...a})=>{const{Element:e="menu",orientation:n="horizontal",isFlipped:i=!1,...c}=a;return(0,t.jsx)(e,{...c,"arc-button-bar":n,"is-flipped":i?"":void 0,role:c.role??"group",children:r})};O("ArcButtonBar",Nc);const Qe=r=>r?.matches(":modal"),rt=(r,a)=>a.target===r,Uc=(r,a)=>a.clientX<r.left||a.clientX>r.right||a.clientY<r.top||a.clientY>r.bottom,Va=({modalRef:r,shouldConfirm:a,setIsConfirming:e,onCloseOverride:n=void 0})=>(i,c)=>s=>{if(s?.preventDefault?.(),s?.stopPropagation?.(),!r?.current){c?.(s);return}if(n){n(i,s,r.current),c?.(s);return}if(a&&i!=="confirm:discard"){e?.(!0);return}r.current?.close(i),e?.(!1),c?.(s)},at=({modalRef:r,shouldConfirm:a,setIsConfirming:e,onClose:n,onToggle:i})=>{(0,b.useEffect)(()=>{const c=r.current;if(!c)return;const s=l=>{Qe(c)&&rt(c,l)&&(a?(l.preventDefault(),l.stopPropagation(),e?.(!0)):n?.("outside",l))},d=l=>{rt(c,l)&&(e?.(!1),n?.(c.returnValue,l),i?.(!1,l))};return c.addEventListener("close",d),c.addEventListener("cancel",s),()=>{c.removeEventListener("close",d),c.removeEventListener("cancel",s)}},[r,a,e,n,i])},et=({modalRef:r,isOpen:a,isTopLayer:e})=>{(0,b.useEffect)(()=>{const n=r.current;n&&(a&&!n.open&&(e?n.showModal():n.show()),!a&&n.open&&n.close())},[a,e])},tt=({modalRef:r,isOpen:a,autoFocusId:e})=>{(0,b.useEffect)(()=>{const n=r.current;if(!n||!e||!a)return;const i=n.querySelector(`#${e}`);if(!i||!(i instanceof HTMLElement))return;const c=setTimeout(()=>{i.focus()},0);return()=>clearTimeout(c)},[r,e,a])},jo=(r,a)=>(typeof r.composedPath=="function"?r.composedPath():[]).includes(a)||r.target instanceof Node&&a.contains(r.target),Eo=({modalRef:r,isOpen:a=!1,closeOnBackdrop:e=!1,attemptCloseModal:n})=>{(0,b.useEffect)(()=>{const i=r.current;if(!i||!a||!e||!Qe(i))return;let c=!1;const s=l=>{c=jo(l,i)},d=l=>{if(c||jo(l,i))return;const p=i.getBoundingClientRect();Uc(p,l)&&n("outside")(l)};return document.documentElement?.addEventListener("pointerdown",s,{capture:!0}),document.documentElement?.addEventListener("click",d,{capture:!0}),()=>{document.documentElement?.removeEventListener("pointerdown",s,{capture:!0}),document.documentElement?.removeEventListener("click",d,{capture:!0})}},[r,n,a,e])},_o=({modalRef:r,isOpen:a=!1,closeOnEsc:e=!1,closedBy:n="closerequest",attemptCloseModal:i})=>{(0,b.useEffect)(()=>{const c=r.current;if(!c||!a||!e||!Qe(c))return;const s=d=>{if(d.key==="Escape"&&rt(c,d)){if(n==="none"){d.stopPropagation(),d.preventDefault();return}i("escape")(d)}};return document.addEventListener("keydown",s),()=>document.removeEventListener("keydown",s)},[r,i,a,e,n])},ot=r=>(0,t.jsx)(ur,{"aria-label":"Dismiss",text:"Dismiss",...r,variant:"common",hierarchy:"tertiary",icon:"fa-regular fa-xmark-large fa-fw",layout:"icon",shape:"square",size:"md"}),nt=r=>(0,t.jsx)("div",{...r,"arc-modal-content":""}),To=({showDivider:r,...a})=>(0,t.jsx)("header",{...a,"arc-modal-header":"","has-divider":r?"":void 0}),Yc=({glyph:r,variant:a="common"})=>(0,t.jsx)(t.Fragment,{children:r&&(0,t.jsx)(B,{icon:r,"arc-modal-glyph":"","arc-icon-status":a})}),it=r=>{const{titleContent:a,TitleElement:e="h2",...n}=r;return(0,t.jsx)(t.Fragment,{children:a&&(0,t.jsx)(e,{...n,"arc-modal-title":"",children:typeof a=="string"?a:(0,t.jsx)(Er,{...a})})})},Wc=({message:r,...a})=>(0,t.jsx)(t.Fragment,{children:r&&(0,t.jsx)("p",{...a,"arc-modal-message":"",children:r})}),ct=({tag:r="section",padding:a,...e})=>(0,t.jsx)(r,{...e,"arc-modal-body":"","data-padding":a==="auto"?void 0:a}),st=({showDivider:r,...a})=>(0,t.jsx)("footer",{...a,"arc-modal-footer":"","has-divider":r?"":void 0}),Zc=r=>a=>{if(a.key==="Escape"){if(r==="none"){a.stopPropagation(),a.preventDefault();return}return"escape"}},y=u`arc•modal`,xa=u`${y}•layout`,Gc=u`${y}•header`,de=u`${y}•body`,Fa=u`${y}•footer`,Br=u`${y}•backdrop`,dr=u`${y}•transition`,pe=u`${y}•size`,k=u`${y}•padding`,$a=u`${Gc}•padding`,N=u`${de}•padding`,Kr=u`${Fa}•padding`,Xc=u`
...
@layer arc-components {
  ...
  ${Qc}
  ${rs}
`,da={variant:"common",backdropColor:"auto",message:"You have unsaved changes. Discard them?",onCloseOverride:void 0,isTopLayer:!0,isInverse:!1},Io=({children:r,headerProps:a,bodyProps:e,footerProps:n,...i})=>{const c=(0,b.useRef)(null),{isOpen:s,autoFocusId:d,isTopLayer:l=da.isTopLayer,isInverse:p=da.isInverse,backdropColor:h=da.backdropColor,variant:v=da.variant,message:g=da.message,onCloseOverride:f=da.onCloseOverride,onConfirmDiscard:w,onConfirmCancel:E,...j}=i,{slotStart:P,TitleElement:A,titleContent:_,slotEnd:S,...C}=a||{},{primaryButton:L,secondaryButton:H,...J}=n||{},X=!!(_||P||S),V=!!f,br=q=>V?f?.("confirm:discard",q,c.current??void 0):w?.("confirm:discard",q),kr=q=>V?f?.("confirm:cancel",q,c.current??void 0):E?.("confirm:cancel",q);at({modalRef:c,onClose:f}),et({modalRef:c,isOpen:s,isTopLayer:l}),tt({modalRef:c,isOpen:s,autoFocusId:d});const Ar=q=>{kr(q),H?.onClick?.(q)},Ir=q=>{br(q),L?.onClick?.(q)};return(0,t.jsx)("dialog",{...j,ref:c,"arc-modal":"","is-confirm":v||"","is-inverse":p?"":void 0,"is-top-layer":l?"":void 0,"is-backdrop":h==="auto"?void 0:h,"data-size":"sm",closedby:"none",onKeyDown:Zc("none"),children:(0,t.jsxs)(nt,{children:[X&&(0,t.jsxs)(To,{...C,children:[P&&(0,t.jsx)("div",{"header-slot":"start",children:P}),(0,t.jsx)("div",{"header-slot":"content",children:(0,t.jsx)(it,{TitleElement:A,titleContent:_})}),S&&(0,t.jsx)("div",{"header-slot":"end",children:S})]}),(0,t.jsx)(ct,{...e,children:r||g&&(0,t.jsx)("p",{style:{margin:0},children:g})}),(0,t.jsx)(st,{...J,children:(0,t.jsxs)(Je,{children:[(0,t.jsx)(ur,{...H,text:H?.text||"Cancel",variant:"common",hierarchy:"secondary",isInverse:p,onClick:Ar}),(0,t.jsx)(ur,{...L,text:L?.text||"Discard",variant:v??"common",hierarchy:"primary",isInverse:p,onClick:Ir})]})})]})})};O("ArcModalConfirm",lt);const fr={size:"md",variant:"common",backdropColor:"auto",isTopLayer:!0,isInverse:!1,showDismiss:!0,closeOnEsc:!0,closeOnBackdrop:!1,hasConfirmFlow:!1,hasUnsavedChanges:!1,onCloseOverride:void 0,bypassConfirmWhen:{didPressEscapeKey:!1,didClickBackdrop:!1,didClickGoBackButton:!1,didClickDismissButton:!1,didClickPrimaryButton:!1,didClickSecondaryButton:!1,didClickTertiaryButton:!1},headerProps:{showDivider:!1},bodyProps:{padding:"auto"},footerProps:{showDivider:!1}},as=({children:r,confirmProps:a,headerProps:e,bodyProps:n,dismissProps:i,footerProps:c,...s})=>{const d=(0,b.useRef)(null),[l,p]=(0,b.useState)(!1),{isOpen:h,autoFocusId:v,isTopLayer:g=fr.isTopLayer,isInverse:f=fr.isInverse,backdropColor:w=fr.backdropColor,hasConfirmFlow:E=fr.hasConfirmFlow,hasUnsavedChanges:j=fr.hasUnsavedChanges,onCloseOverride:P=fr.onCloseOverride,bypassConfirmWhen:A=fr.bypassConfirmWhen??{},size:_=fr.size,closeOnBackdrop:S=fr.closeOnBackdrop,closeOnEsc:C=fr.closeOnEsc,showDismiss:L=fr.showDismiss,onActionError:H,onClose:J,onToggle:X,width:V,height:br,style:kr,...Ar}=s,{showGoBack:Ir,goBackProps:q,slotStart:xr,TitleElement:ra,titleContent:Lr,slotEnd:Zr,showDivider:Gr=fr.headerProps?.showDivider,...Mr}=e??{},{slotStart:Dr,primaryButton:zr,secondaryButton:pr,tertiaryButton:R,showDivider:cr=fr.footerProps?.showDivider,...hr}=c??{},er=!!(Ir||Lr||xr||Zr),W=!!(zr||pr||R),vr=!!(W||Dr),Cr=!!(E&&j),$r=C?"closerequest":"none",{didPressEscapeKey:aa,didClickBackdrop:he,didClickGoBackButton:ve,didClickDismissButton:Xr,didClickPrimaryButton:ml,didClickSecondaryButton:gl,didClickTertiaryButton:fl}=A,me=Va({modalRef:d,shouldConfirm:Cr,setIsConfirming:p,onCloseOverride:P});at({modalRef:d,shouldConfirm:Cr,setIsConfirming:p,onClose:J,onToggle:X}),et({modalRef:d,isOpen:h,isTopLayer:g}),tt({modalRef:d,isOpen:h,autoFocusId:v}),Eo({modalRef:d,isOpen:h,closeOnBackdrop:S,attemptCloseModal:he?Va({modalRef:d,shouldConfirm:Cr&&!he,setIsConfirming:p}):me}),_o({modalRef:d,isOpen:h,closeOnEsc:C,closedBy:$r,attemptCloseModal:aa?Va({modalRef:d,shouldConfirm:Cr&&!aa,setIsConfirming:p}):me});const bl=()=>p(!1),xl=(Ya,ge)=>me(Ya)(ge),ka=(Ya,ge,pt)=>async Aa=>{Aa?.preventDefault?.(),Aa?.stopPropagation?.();const $l=()=>ge?Va({modalRef:d,shouldConfirm:Cr&&!ge,setIsConfirming:p})(Ya,pt?.onCloseCallback)(Aa):me(Ya,pt?.onCloseCallback)(Aa);try{await pt?.onClick?.(Aa),$l()}catch(yl){H?.(yl,{reason:Ya,event:Aa})}};return(0,t.jsxs)("dialog",{...Ar,ref:d,"arc-modal":"","is-inverse":f?"":void 0,"is-top-layer":g?"":void 0,"is-backdrop":w==="auto"?void 0:w,"data-size":_,closedby:$r,style:{"--arc-modal-width":V??"","--arc-modal-height":br??"",...kr},children:[!er&&L&&(0,t.jsx)("div",{"arc-modal-dismiss":"",children:(0,t.jsx)(ot,{...i,isInverse:f,onClick:ka("button:dismiss",Xr,i)})}),(0,t.jsxs)(nt,{inert:l?"":void 0,children:[er&&(0,t.jsxs)(To,{...Mr,showDivider:Gr,children:[Ir&&(0,t.jsx)("div",{"header-slot":"go-back",children:(0,t.jsx)(ur,{"arc-modal-go-back":"",icon:"fa-regular fa-arrow-left fa-fw",text:"Go Back","aria-label":"Go Back",...q,layout:"icon",size:"md",variant:"common",hierarchy:"secondary",isInverse:f,onClick:ka("button:back",ve,q)})}),xr&&(0,t.jsx)("div",{"header-slot":"start",children:xr}),(0,t.jsx)("div",{"header-slot":"content",children:(0,t.jsx)(it,{TitleElement:ra,titleContent:Lr})}),Zr&&(0,t.jsx)("div",{"header-slot":"end",children:Zr}),L&&(0,t.jsx)("div",{"header-slot":"dismiss",children:(0,t.jsx)(ot,{...i,isInverse:f,onClick:ka("button:dismiss",Xr,i)})})]}),(0,t.jsx)(ct,{...n,children:r}),vr&&(0,t.jsxs)(st,{...hr,showDivider:cr,children:[Dr&&(0,t.jsx)("div",{"footer-slot":"content",children:Dr}),W&&(0,t.jsxs)(Je,{children:[R&&(0,t.jsx)(ur,{...R,text:R?.text||"Button",isInverse:f,variant:"common",hierarchy:"tertiary",onClick:ka("button:tertiary",fl,R)}),pr&&(0,t.jsx)(ur,{...pr,text:pr?.text||"Cancel",isInverse:f,variant:"common",hierarchy:"secondary",onClick:ka("button:secondary",gl,pr)}),zr&&(0,t.jsx)(ur,{...zr,text:zr?.text||"Action",isInverse:f,variant:"common",hierarchy:"primary",onClick:ka("button:primary",ml,zr)})]})]})]}),E&&(0,t.jsx)(Io,{isOpen:l,isInverse:f,isTopLayer:g,backdropColor:w,...a,onConfirmDiscard:xl,onConfirmCancel:bl})]})};O("ArcModal",lt);const Jr={variant:"common",backdropColor:"auto",showDismiss:!0,closeOnBackdrop:!1,closeOnEsc:!0,onCloseOverride:void 0,isTopLayer:!0,isInverse:!1},es={common:"fa-solid fa-cat-space",brand:"fa-kit fa-articulate",success:"fa-solid fa-badge-check",warning:"fa-solid fa-triangle-exclamation",error:"fa-duotone fa-light-emergency-on",info:"fa-solid fa-circle-info",processing:(0,t.jsx)(Ue,{"arc-modal-spinner":""})},ts=({children:r,dismissProps:a,bodyProps:e,footerProps:n,...i})=>{const c=(0,b.useRef)(null),{isOpen:s,autoFocusId:d,isTopLayer:l=Jr.isTopLayer,isInverse:p=Jr.isInverse,backdropColor:h=Jr.backdropColor,closeOnBackdrop:v=Jr.closeOnBackdrop,closeOnEsc:g=Jr.closeOnEsc,variant:f=Jr.variant,icon:w,TitleElement:E,titleContent:j,message:P,showDismiss:A,onCloseOverride:_=Jr.onCloseOverride,onClose:S,onToggle:C,...L}=i,{primaryButton:H,...J}=n??{},X=w||es[f],V=g?"closerequest":"none",br=Va({modalRef:c,onCloseOverride:_});return at({modalRef:c,onClose:S,onToggle:C}),et({modalRef:c,isOpen:s,isTopLayer:l}),tt({modalRef:c,isOpen:s,autoFocusId:d}),Eo({modalRef:c,isOpen:s,closeOnBackdrop:v,attemptCloseModal:br}),_o({modalRef:c,isOpen:s,closeOnEsc:g,closedBy:V,attemptCloseModal:br}),(0,t.jsxs)("dialog",{...L,ref:c,"arc-modal":"","is-alert":f||"","is-inverse":p?"":void 0,"is-top-layer":l?"":void 0,"is-backdrop":h==="auto"?void 0:h,"data-size":"sm",closedby:V,children:[A&&(0,t.jsx)("div",{"arc-modal-dismiss":"",children:(0,t.jsx)(ot,{...a,isInverse:p,onClick:br("button:dismiss",a?.onClick)})}),(0,t.jsxs)(nt,{children:[(0,t.jsx)(ct,{...e,children:r||(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(Yc,{glyph:X,variant:f}),(0,t.jsx)(it,{TitleElement:E,titleContent:j}),(0,t.jsx)(Wc,{message:P})]})}),(0,t.jsx)(st,{...J,children:(0,t.jsx)(Je,{orientation:"vertical",children:(0,t.jsx)(ur,{...H,text:H?.text||"Close",variant:"common",hierarchy:"primary",isInverse:p,onClick:br("button:primary",H?.onClick)})})})]})]})};O("ArcModalAlert",lt);const os=u`
@layer arc-components {
...
`,ns=z(Hr,["hug","fill"]),is=z(yr,["inherit","md","sm"]),Lo=({children:r,label:a,layout:e,size:n="md",useMask:i=!0,...c})=>{const{className:s,title:d,...l}=c,p={className:s,title:d},h=r??a,v=(0,t.jsx)(Oa,{...l,type:"radio"}),g=i&&(0,t.jsxs)(le,{type:"radio",children:[v,(0,t.jsx)(B,{icon:"fa-solid fa-circle-small arc-fw"})]}),f=!!h&&(0,t.jsxs)(ca,{layout:e,children:[g||v,(0,t.jsx)(sa,{children:h})]});return(0,t.jsx)("span",{...p,"arc-radio":"","data-size":n,children:f||g||v})};O("ArcRadio",os);const cs=u`
@layer arc-components {
...
`,ss=z(Hr,["hug","fill"]),ls=z(yr,["lg","md"]),ds=({children:r,label:a,icon:e,...n})=>{const i=r||(0,t.jsx)(Er,{icon:e,text:a});return(0,t.jsx)("li",{"arc-radio-bar-option":"","data-is-checked":n?.checked||void 0,children:(0,t.jsx)(Lo,{...n,label:i,layout:"fill",useMask:!1})})},ps=({children:r,size:a="lg",layout:e="hug",...n})=>(0,t.jsx)("ul",{...n,"arc-radio-bar":"","data-size":a,"data-layout":e,role:"radiogroup",children:r});O("ArcRadioBar",cs);const Mo=z(Hr,["fill","hug"]),Po=z(yr,["inherit","xl","lg","md"]),us=z(Q,["outline","solid","plain"]),hs=Mo,vs=Po,ms=z(Q,["outline","solid","plain"]),ya=r=>(0,t.jsx)(t.Fragment,{children:!!r.children&&(0,t.jsx)("span",{...r})}),gs=r=>(0,t.jsx)(t.Fragment,{children:!!r.children&&(0,t.jsx)("span",{...r})}),dt=({children:r,...a})=>(0,t.jsx)(t.Fragment,{children:!!r&&(0,t.jsx)(ca,{...a,children:(0,t.jsx)(sa,{children:r})})}),fs=({children:r,layout:a,size:e,variant:n,tag:i="span",...c})=>(0,t.jsx)(i,{...c,"data-layout":a,"data-size":e,"data-variant":n,children:r}),bs=()=>(0,t.jsx)("span",{"input-element":"spacer"}),xs=r=>(0,t.jsx)(ya,{...r,"input-element":"header"}),$s=r=>(0,t.jsx)(dt,{...r,"input-element":"header-label"}),ys=r=>(0,t.jsx)(ya,{...r,"input-element":"header-slot"}),ws=r=>(0,t.jsx)(ya,{...r,"input-element":"body"}),ks=r=>(0,t.jsx)(dt,{...r,"input-element":"input-prefix"}),As=r=>(0,t.jsx)(dt,{...r,"input-element":"input-suffix"}),zs=r=>(0,t.jsx)(gs,{...r,"input-element":"input-action"}),Cs=r=>(0,t.jsx)(ya,{...r,"input-element":"footer"}),Ss=r=>(0,t.jsx)(ya,{...r,"input-element":"footer-caption"}),js=r=>(0,t.jsx)(ya,{...r,"input-element":"footer-slot"}),Es=r=>a=>{if(!(a?.target instanceof HTMLInputElement))return;const e={name:a?.target?.name,value:a?.target?.value};r?.(e,a)},_s=u`
@layer arc-components {
...
`,Ts={onChangeHandler:Es,Wrapper:fs,Spacer:bs,Header:xs,HeaderLabel:$s,HeaderSlot:ys,InputBody:ws,InputPrefix:ks,InputSuffix:As,InputAction:zs,Footer:Cs,FooterCaption:Ss,FooterSlot:js};O("ArcInput",_s);const U=Ts,ue=u`arc•select`,Qr=u`${ue}•picker`,Or=u`${ue}•option`,Na=u`${ue}size`,Wr=u`${ue}•space`,Is=u`
@layer arc-components {
...
`,Ls=(0,b.forwardRef)(({layout:r="hug",size:a="inherit",variant:e="outline",items:n,renderItem:i,headerLabel:c,headerSlot:s,footerCaption:d,footerSlot:l,readOnly:p,id:h,onChange:v,onBlur:g,onFocus:f,onKeyDown:w,onKeyUp:E,onInput:j,onInvalid:P,onClick:A,name:_,value:S,defaultValue:C,required:L,disabled:H,autoComplete:J,autoFocus:X,form:V,...br},kr)=>{const Ar=Sr(h,"arc-select"),Ir=e==="plain"&&r==="fill"?"hug":r,q=H||void 0,xr=p||void 0,ra=L||void 0,Lr=!!(globalThis?.CSS&&typeof CSS.supports=="function"&&CSS.supports("appearance","base-select")),Zr=e!=="plain"&&!!(c||s),Gr=e!=="plain"&&!!(d||l),Mr=n?.filter(R=>R?.variant!=="divider"&&R?.variant!=="section-label")??[],Dr=R=>{const cr=er=>typeof er=="string"&&er.trim().length>0;return[R?.text,R?.avatar?.name,R?.["aria-label"]].find(cr)??"Anonymous"},zr=(R,cr)=>{if(i)return i(R,cr);const hr=Da(R),er=zo(hr),{itemId:W,...vr}=R;return er(vr)},pr=xr&&(S!=null||C!=null)?String(S??C):void 0;return(0,t.jsxs)(U.Wrapper,{...br,"arc-select":"","arc-input":"select",layout:Ir,size:a,variant:e,children:[Zr&&(0,t.jsxs)(U.Header,{children:[(0,t.jsx)(U.HeaderLabel,{htmlFor:Ar,children:c}),!!s&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.HeaderSlot,{children:s})]})]}),(0,t.jsx)(U.InputBody,{children:(0,t.jsxs)("select",{name:_,value:S,defaultValue:C,required:L,disabled:H,autoComplete:J,autoFocus:X,form:V,ref:kr,id:Ar,onChange:v,onBlur:g,onFocus:f,onKeyDown:w,onKeyUp:E,onInput:j,onInvalid:P,onClick:A,"aria-disabled":q,"aria-required":ra,"data-readonly":xr,children:[(0,t.jsxs)("button",{children:[(0,t.jsx)("selectedcontent",{}),(0,t.jsx)("span",{"data-element":"picker-icon","aria-hidden":!0,children:(0,t.jsx)(B,{icon:"fa-regular fa-angle-down arc-fw"})})]}),Mr.map((R,cr)=>{const hr=R["aria-disabled"]===!0||R.disabled===!0,er=String(R?.value??R?.itemId??cr),W=Da(R),vr=Dr(R);return(0,t.jsx)("option",{value:er,disabled:hr||pr!==void 0&&er!==pr||void 0,"arc-select-option":"","arc-select-option-role":W,children:Lr?(0,t.jsxs)(t.Fragment,{children:[zr(R,cr),(0,t.jsx)("span",{"data-element":"selected-icon","aria-hidden":!0,children:(0,t.jsx)(B,{icon:"fa-regular fa-check arc-fw"})})]}):vr},R.itemId??cr)})]})}),Gr&&(0,t.jsxs)(U.Footer,{children:[(0,t.jsx)(U.FooterCaption,{children:d}),!!l&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.FooterSlot,{children:l})]})]})]})});O("ArcSelect",Is);const Ms=z(yr,["inherit","md","sm"]),ar={On:"on",Off:"off"},wa={Before:"before",After:"after"},Ps=({disabled:r,id:a,name:e,size:n="md",value:i,labelOff:c,labelOn:s,onChange:d,...l})=>{const p=Sr(e,"arc-switch-name"),h=Sr(a?`${a}-off`:void 0,"arc-switch-off"),v=Sr(a?`${a}-on`:void 0,"arc-switch-on"),g=A=>{if(A.code==="Space"){A.preventDefault(),A.stopPropagation();const _=i===ar.On?ar.Off:ar.On;d?.({value:_},A)}},f=A=>{const _={on:Ta(s),off:Ta(c)};return _?.on&&_?.off?_[A]:!_?.on&&_?.off?`${_?.off}: ${A}`:_?.on&&!_?.off?`${_?.on}: ${A}`:_[A]},w=(0,t.jsxs)(le,{type:"switch",onKeyDown:g,children:[(0,t.jsx)(Oa,{type:"switch",name:p,id:h,value:ar.Off,checked:i===ar.Off,disabled:r,"aria-label":f(ar.Off)?.trim(),onChange:d}),(0,t.jsx)(Oa,{type:"switch",name:p,id:v,value:ar.On,checked:i===ar.On,disabled:r,"aria-label":f(ar.On)?.trim(),onChange:d}),(0,t.jsx)("span",{"data-element":"mask"})]}),E=!s&&i===ar.Off?v:h,j=!c&&i===ar.On?h:v,P=!!(s||c)&&(0,t.jsxs)(t.Fragment,{children:[!!c&&(0,t.jsx)(ca,{htmlFor:E,"arc-switch-label":s?ar.Off:"",children:(0,t.jsx)(sa,{children:c})}),w,!!s&&(0,t.jsx)(ca,{htmlFor:j,"arc-switch-label":c?ar.On:"",children:(0,t.jsx)(sa,{children:s})})]});return(0,t.jsx)("span",{...l,"arc-switch":"","data-state":i,"data-size":n,role:"radiogroup",children:P||w})},Rs=u`
@layer arc-components {
...
`,Bs=({disabled:r,id:a,name:e,size:n="md",value:i,label:c,labelPosition:s=wa.After,onChange:d,labelOff:l,labelOn:p,...h})=>{const v=Sr(e,"arc-switch-name"),g=Sr(a,"arc-switch"),f=(j,P)=>{const A=j.checked?ar.On:ar.Off;d?.({...j,value:A},P)};!c&&(p||l)&&(c=p||l,s=p?wa.After:wa.Before);const w=(0,t.jsxs)(le,{type:"checkbox",children:[(0,t.jsx)(Oa,{type:"checkbox",name:v,id:g,checked:i===ar.On,disabled:r,role:"switch","aria-checked":i===ar.On,"aria-label":c?void 0:"Toggle switch",tabIndex:0,onChange:f}),(0,t.jsx)("span",{"data-element":"mask","aria-hidden":"true",tabIndex:-1})]}),E=(0,t.jsx)(ca,{htmlFor:g,"arc-switch-label":s,children:(0,t.jsx)(sa,{children:c})});return l&&p?(0,t.jsx)(Ps,{...h,disabled:r,id:a,name:e,labelOff:l,labelOn:p,size:n,value:i,onChange:d}):(0,t.jsxs)("span",{...h,"arc-switch":"","data-state":i,"data-size":n,"data-label-position":s,role:"presentation","aria-live":"off",children:[c&&s===wa.Before&&E,w,c&&s===wa.After&&E]})};O("ArcSwitch",Rs);const Os=["title","heading","subheading","body"],Ro=["h1","h2","h3","h4","h5","h6"],Bo=["code","div","li","p","pre","span"],Oo=[...Ro,...Bo],Ds=["title-inherit","title-lg","title-md","title-sm"],Hs=["heading-inherit","heading-lg","heading-md","heading-sm"],Vs=["subheading-inherit","subheading-lg","subheading-md","subheading-sm"],Fs=z(Q,["inherit","primary","primary-inverse"]),Ns=["body-inherit","body-lg","body-md","body-sm","body-xs"],Us=z(Q,["inherit","primary","secondary","primary-inverse","secondary-inverse","critical","warning","success","info"]),Ys=z(vt,["inherit","start","center","justify","end"]),Ws=z(mt,["inherit","loose","standard","tight"]),Zs={h1:"title",h2:"heading",h3:"heading",h4:"subheading",h5:"subheading",h6:"subheading",p:"body",span:"body",div:"body",code:"body",pre:"body",li:"body"},Gs=r=>{const{align:a,lineHeight:e,size:n,variant:i,isMonospace:c,tag:s,...d}=r,l=Zs?.[s]??"body",p=n?.includes("inherit")?n?.split("-")?.[0]:n;return{...d,"arc-text":p||l,"data-is-monospace":c?"":void 0,"data-align":a?.includes("inherit")?void 0:a,"data-variant":i?.includes("inherit")?void 0:i,"data-line-height":e?.includes("inherit")?void 0:e}},Xs=u`
@layer arc-components {
...
`,qs=r=>(0,b.forwardRef)((a,e)=>(0,b.createElement)(r,{...Gs({...a,tag:r}),ref:e})),Ks=[...Oo].reduce((r,a)=>({...r,[a]:qs(a)}),{});O("Arc",Xs);const Js=Mo,Qs=Po,rl=z(us,["outline","solid"]),al=["text","number","password","email","url"],el=(0,b.forwardRef)(({layout:r="hug",size:a="inherit",variant:e="outline",inputProps:n,headerLabel:i,headerSlot:c,inputPrefix:s,inputAction:d,inputSuffix:l,footerCaption:p,footerSlot:h,...v},g)=>{const{id:f,onChange:w,...E}=n,j=E?.type||"text",P=E?.disabled||void 0,A=E?.readOnly||void 0,_=E?.required||void 0,S=!!(i||c),C=!!(p||h);return(0,t.jsxs)(U.Wrapper,{...v,"arc-text-input":"","arc-input":j,layout:r,size:a,variant:e,children:[S&&(0,t.jsxs)(U.Header,{children:[(0,t.jsx)(U.HeaderLabel,{htmlFor:f,children:i}),!!c&&(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.HeaderSlot,{children:c})]}),(0,t.jsxs)(U.InputBody,{children:[(0,t.jsx)(U.InputPrefix,{htmlFor:f,children:s}),(0,t.jsx)("input",{...E,ref:g,id:f,"arc-input-type":j,onChange:U.onChangeHandler(w),"aria-disabled":P,"aria-readonly":A,"aria-required":_}),(0,t.jsx)(U.InputSuffix,{htmlFor:f,children:l}),(0,t.jsx)(U.InputAction,{children:d})]}),C&&(0,t.jsxs)(U.Footer,{children:[(0,t.jsx)(U.FooterCaption,{children:p}),!!h&&(0,t.jsx)(U.Spacer,{}),(0,t.jsx)(U.FooterSlot,{children:h})]})]})}),Do=u`arc•progress`,Ho=u`${Do}•bar`,Ua=u`${Do}•value`,tl=u`
@layer arc-components {
[arc-progress-bar] {
...
`,ol=({progress:r=0,variant:a="common",...e})=>(0,t.jsxs)("progress",{...e,"arc-progress-bar":"","data-variant":a,value:r,max:e.max||100,"aria-valuenow":r,"aria-valuemax":e.max||100,children:[r,"% "]});O("ArcProgressBar",tl);const nl=u`
@layer arc-components {
...
`,il=z(Q,["common","ai","critical"]),cl=["default","success","warning","error"],sl=z(yr,["inherit","md"]),ll=z(Q,["common"]),dl=[...xe],pl=[...Za],ul=["top-left","top-center","top-right","center","bottom-left","bottom-center","bottom-right"],hl=il.filter(r=>r!=="critical"),vl=(r,a="toggle")=>{const e=document.getElementById(r);({toggle:()=>e?.togglePopover(),show:()=>e?.showPopover(),hide:()=>e?.hidePopover()})[a]()},Vo=({id:r,children:a,icon:e,heading:n,subtext:i,dismissProps:c,showDismiss:s=!0,onClose:d,actionSlot:l,size:p="md",variant:h="common",placement:v="bottom-left",getToastId:g,progressBarProps:f,severity:w,...E})=>{const j=()=>{d?.()},P=!!l||s,A=Sr(r,"arc-toast"),{variant:_,hierarchy:S,...C}=c||{};(0,b.useEffect)(()=>{g?.(A)},[g,A]);const L=Gt(e);return(0,t.jsx)("div",{...E,"arc-toast":"","data-size":p,"data-variant":h,"data-placement":v,"data-severity":w||void 0,id:A,children:(0,t.jsxs)("div",{"arc-toast-content-grid":"",children:[(0,t.jsxs)("div",{"arc-toast-body":"",children:[e&&(0,t.jsx)(B,{icon:L,"arc-toast-icon":""}),(0,t.jsx)("div",{"arc-toast-content":"",children:a||(0,t.jsxs)(t.Fragment,{children:[n&&(0,t.jsx)("header",{"arc-toast-heading":"",children:(0,t.jsx)("strong",{children:n})}),i&&(0,t.jsx)("p",{"arc-toast-subtext":"",children:i})]})})]}),P&&(0,t.jsxs)("div",{"arc-toast-actions":"",children:[l,s&&(0,t.jsx)(ur,{icon:"fa-regular fa-xmark-large",layout:"icon",variant:"common",hierarchy:"tertiary",isInverse:!0,size:"md",shape:"square","aria-label":"Dismiss",...C,popoverTarget:A,onClick:j})]}),f&&(0,t.jsx)(ol,{...f,variant:w==="error"?"critical":f.variant,"arc-toast-progress-bar":""})]})})};Vo.handleToast=vl,O("ArcToast",nl)}}]);
